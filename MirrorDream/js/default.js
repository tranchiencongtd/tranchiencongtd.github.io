  ...
  !(function (e) {
    ...
    (function (e, t) {
      ...
      function c(e) {
        var t = {};
        return (
          xe.each(e.match(Ie) || [], function (e, n) {
            t[n] = !0;
          }),
          t
        );
      ...
      function h(e) {
        return e.replace(Le, "ms-").replace(qe, d);
      }
      function y() {
            ...
            r.style &&
              ...
              t
                ? ("none" === n &&
                    ...
                    i[o] || (r.style.display = "")),
                  "" === r.style.display && Ue(r) && (i[o] = b(r)))
                : "none" !== n &&
                  ((i[o] = "none"), Fe.set(r, "display", n)));
        for (o = 0; o < a; o++)
        ...
        return (
          (n =
            void 0 !== e.getElementsByTagName
              ...
              : []),
          void 0 === t || (t && o(e, t)) ? xe.merge([e], n) : n
        );
      }
      function T(e, t) {
      ...
      function S(e, t, n, i, o) {
            ...
            if ("object" === r(a)) xe.merge(d, a.nodeType ? [a] : a);
              ...
              for (
                s = s || p.appendChild(t.createElement("div")),
                  ...
                  u = Qe[c] || Qe._default,
                  s.innerHTML = u[1] + xe.htmlPrefilter(a) + u[2],
                  f = u[0];
                f--;
        ...
        for (p.textContent = "", h = 0; (a = d[h++]); )
          if (i && xe.inArray(a, i) > -1) o && o.push(a);
            ...
            ((l = xe.contains(a.ownerDocument, a)),
      ...
      function _(e, t) {
        ...
        if (1 === t.nodeType) {
          if (
            Fe.hasData(e) &&
            ((o = Fe.access(e)), (a = Fe.set(t, o)), (u = o.events))
          ) {
          ...
          He.hasData(e) &&
            ((s = He.access(e)), (c = xe.extend({}, s)), He.set(t, c));
        }
      }
      function I(e, t) {
      ...
      function P(e, t, r, i) {
        ...
        if (
          y ||
          (p > 1 && "string" == typeof h && !me.checkClone && at.test(h))
        )
          return e.each(function (n) {
            var o = e.eq(n);
            y && (t[0] = h.call(this, n, o.html())), P(o, t, r, i);
          });
        if (
          p &&
          ...
          for (s = xe.map(x(o, "script"), E), c = s.length; f < p; f++)
            (u = o),
              f !== d &&
                ((u = xe.clone(u, !0, !0)),
                c && xe.merge(s, x(u, "script"))),
              r.call(e[f], u, f);
          if (c)
            for (
              l = s[s.length - 1].ownerDocument, xe.map(s, N), f = 0;
              f < c;
              f++
            )
              (u = s[f]),
                Ze.test(u.type || "") &&
                  !Fe.access(u, "globalEval") &&
                  xe.contains(l, u) &&
                  (u.src && "module" !== (u.type || "").toLowerCase()
                    ? xe._evalUrl && xe._evalUrl(u.src)
                    : n(u.textContent.replace(st, ""), l, u));
        }
        return e;
      }
      function M(e, t, n) {
        for (
          var r, i = t ? xe.filter(t, e) : e, o = 0;
          null != (r = i[o]);
          o++
        )
      ...
      function q(e) {
        if (e in gt) return e;
        for (
          var t = e[0].toUpperCase() + e.slice(1), n = yt.length;
          n--;
      ...
      function H(e, t, n, r, i, o) {
        ...
        for (; a < 4; a += 2)
          "margin" === n && (c += xe.css(e, n + We[a], !0, i)),
            r
              ? ("content" === n &&
                  (c -= xe.css(e, "padding" + We[a], !0, i)),
                "margin" !== n &&
                  (c -= xe.css(e, "border" + We[a] + "Width", !0, i)))
              : ((c += xe.css(e, "padding" + We[a], !0, i)),
                "padding" !== n
                  ? (c += xe.css(e, "border" + We[a] + "Width", !0, i))
                  : (s += xe.css(e, "border" + We[a] + "Width", !0, i)));
        return (
          !r &&
            o >= 0 &&
            (c += Math.max(
      ...
      function V(e, t, n) {
        ...
        return (
          (a = a && (me.boxSizingReliable() || i === e.style[t])),
          ("auto" === i ||
            (!parseFloat(i) &&
              "inline" === xe.css(e, "display", !1, r))) &&
            ((i = e["offset" + t[0].toUpperCase() + t.slice(1)]),
            (a = !0)),
          (i = parseFloat(i) || 0) +
            H(e, t, n || (o ? "border" : "content"), a, r, i) +
            "px"
        );
      }
      function $(e, t, n, r, i) {
      ...
      function G(e, t, n) {
        ...
        if ((c = !xe.isEmptyObject(t)) || !xe.isEmptyObject(d)) {
          f &&
            1 === e.nodeType &&
          ...
          for (r in d)
            c ||
              (g
                ...
                : (g = Fe.access(e, "fxshow", { display: u })),
              o && (g.hidden = !y),
              y && w([e], !0),
              p.done(function () {
                y || w([e]), Fe.remove(e, "fxshow");
      ...
      function Y(e, t, n) {
        ...
        for (X(l, u.opts.specialEasing); o < a; o++)
          if ((r = Y.prefilters[o].call(u, e, l, u.opts)))
            return (
              ve(r.stop) &&
                (xe._queueHooks(u.elem, u.opts.queue).stop = r.stop.bind(
                  r
                )),
              r
            );
        return (
          xe.map(l, U, u),
          ve(u.opts.start) && u.opts.start.call(e, u),
          u
          ...
          xe.fx.timer(
            xe.extend(c, { elem: e, anim: u, queue: u.opts.queue })
          ),
          u
        );
      }
      ...
      (xe.fn = xe.prototype = {
              ...
              for (t in e)
                (n = a[t]),
                  ...
                  a !== r &&
                    (u &&
                    r &&
                    (xe.isPlainObject(r) || (i = Array.isArray(r)))
                      ? (i
                          ? ((i = !1),
                            (o = n && Array.isArray(n) ? n : []))
                          : (o = n && xe.isPlainObject(n) ? n : {}),
                        (a[t] = xe.extend(u, o, r)))
                      : void 0 !== r && (a[t] = r));
          return a;
        }),
        ...
        "function" == typeof Symbol &&
          (xe.fn[Symbol.iterator] = oe[Symbol.iterator]),
        xe.each(
      ...
      var Se = (function (e) {
          ...
          return (
            ...
            r(function (r, a, s, c) {
              var u,
                ...
                v = !e || (!r && t) ? m : y(m, p, e, s, c),
                b = n ? (o || (r ? e : g || i) ? [] : a) : v;
              if ((n && n(v, b, s, c), i))
                for (u = y(b, d), i(u, [], s, c), l = u.length; l--; )
                  (f = u[l]) && (b[d[l]] = !(v[d[l]] = f));
              if (r) {
                if (o || e) {
                  if (o) {
              ...
              } else (b = y(b === a ? b.splice(g, b.length) : b)), o ? o(null, a, b, c) : J.apply(a, b);
            })
          );
        }
        function m(e) {
          ...
          var i = n.length > 0,
            ...
            a = function (r, a, s, c, u) {
              ...
              for (
                ...
                if (o && l) {
                  for (
                    f = 0, a || l.ownerDocument === _ || (N(l), (s = !P));
                    (p = e[f++]);
        ...
        try {
          J.apply((G = Z.call(F.childNodes)), F.childNodes),
        ...
        (w = t.support = {}),
            ...
            return r !== _ && 9 === r.nodeType && r.documentElement
              ? ((_ = r),
                ...
                (w.getById = i(function (e) {
                  return (
                    (I.appendChild(e).id = R),
                    !_.getElementsByName || !_.getElementsByName(R).length
                  );
                })),
                w.getById
                ...
                (D = []),
                (M = []),
                (w.qsa = he.test(_.querySelectorAll)) &&
                  (i(function (e) {
                  ...
                  ? function (e, t) {
                      ...
                      return (
                        ...
                        (!w.sortDetached &&
                          ...
                          ? e === _ || (e.ownerDocument === F && q(F, e))
                            ? -1
                            : t === _ ||
                              (t.ownerDocument === F && q(F, t))
                            ? 1
                            : C
                            ? Q(C, e) - Q(C, t)
                            : 0
          ...
          (t.contains = function (e, t) {
            return (e.ownerDocument || e) !== _ && N(e), q(e, t);
          }),
          (t.attr = function (e, t) {
            (e.ownerDocument || e) !== _ && N(e);
          ...
          (x = t.selectors = {
            ...
            preFilter: {
              ATTR: function (e) {
                return (
                  (e[1] = e[1].replace(me, ve)),
                  (e[3] = (e[3] || e[4] || e[5] || "").replace(me, ve)),
                  "~=" === e[2] && (e[3] = " " + e[3] + " "),
                  e.slice(0, 4)
                );
              },
          ...
          (k = t.select = function (e, t, n, r) {
            ...
            if (((n = n || []), 1 === p.length)) {
              if (
                ...
                if (
                  !(t = (x.find.ID(a.matches[0].replace(me, ve), t) ||
                    [])[0])
                )
                  return n;
                l && (t = t.parentNode),
      ...
      (xe.find = Se),
        (xe.expr = Se.selectors),
        (xe.expr[":"] = xe.expr.pseudos),
        (xe.uniqueSort = xe.unique = Se.uniqueSort),
        (xe.text = Se.getText),
        (xe.isXMLDoc = Se.isXML),
        (xe.contains = Se.contains),
        (xe.escapeSelector = Se.escape);
        ...
        if (((n = n || Ce), "string" == typeof e)) {
          ...
          if (r[1]) {
            if (
              ...
              for (r in t)
                ve(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
            return this;
          }
          return (
          ...
          function (e, t) {
            xe.fn[e] = function (n, r) {
              ...
              return (
                ...
                this.length > 1 &&
                  (_e[e] || xe.uniqueSort(i), Ne.test(e) && i.reverse()),
                this.pushStack(i)
              );
            };
          }
      ...
      (xe.Callbacks = function (e) {
        e = "string" == typeof e ? c(e) : xe.extend({}, e);
        var t,
          n,
          i,
          o,
            ...
            var n = [
              ...
              i = {
                ...
                then: function (t, r, i) {
                  ...
                  return xe
                    .Deferred(function (e) {
                      n[0][3].add(o(0, e, ve(i) ? i : u, e.notifyWith)),
                        n[1][3].add(o(0, e, ve(t) ? t : u)),
                        n[2][3].add(o(0, e, ve(r) ? r : l));
                    })
                    .promise();
                },
                promise: function (e) {
            ...
            var t = arguments.length,
              ...
              a = function (e) {
                return function (n) {
                  (r[e] = this),
                    (i[e] =
                      arguments.length > 1 ? ce.call(arguments) : n),
                    --t || o.resolveWith(r, i);
                };
              };
            if (
              ...
              "pending" === o.state() || ve(i[n] && i[n].then))
            )
              return o.then();
        ...
        xe.extend({
          ...
          ready: function (e) {
            (!0 === e ? --xe.readyWait : xe.isReady) ||
              ((xe.isReady = !0),
              (!0 !== e && --xe.readyWait > 0) ||
                Me.resolveWith(ae, [xe]));
          },
        }),
        (xe.ready.then = Me.then),
      ...
      var De = function e(t, n, i, o, a, s, c) {
          var u = 0,
            l = t.length,
            f = null == i;
          if ("object" === r(i)) {
            ...
            f &&
              (c
                ...
                : ((f = n),
                  (n = function (e, t, n) {
                    return f.call(xe(e), n);
                  }))),
            n)
          )
            for (; u < l; u++)
              n(t[u], i, c ? o : o.call(t[u], u, n(t[u], i)));
          ...
          queue: function (e, t, n) {
            ...
            if (e)
              return (
                ...
                n &&
                  (!r || Array.isArray(n)
                    ? (r = Fe.access(e, t, xe.makeArray(n)))
                    : r.push(n)),
                r || []
              );
          },
                  ...
                  (l = xe.extend(
                    {
                      ...
                      selector: i,
                      needsContext:
                        i && xe.expr.match.needsContext.test(i),
                      namespace: h.join("."),
                    },
                    o
                  )),
            ...
            for (t = (t || "").match(Ie) || [""], u = t.length; u--; )
              if (
                ...
                a &&
                  ...
                  delete c[d]);
              } else for (d in c) xe.event.remove(e, d + t[u], n, r, !0);
            xe.isEmptyObject(c) && Fe.remove(e, "handle events");
          }
        },
        dispatch: function (e) {
          var t,
          ...
          if (
            ...
            for (
              a = xe.event.handlers.call(this, s, u), t = 0;
              ...
              for (
                ...
                (s.rnamespace && !s.rnamespace.test(o.namespace)) ||
                  ...
                  void 0 !==
                    (r = (
                      (xe.event.special[o.origType] || {}).handle ||
                      o.handler
                    ).apply(i.elem, c)) &&
                    !1 === (s.result = r) &&
      ...
      xe.extend({
        ...
        clone: function (e, t, n) {
          var r,
            ...
            a,
            s = e.cloneNode(!0),
            c = xe.contains(e.ownerDocument, e);
          if (
            !(
              me.noCloneChecked ||
            ...
            for (a = x(s), o = x(e), r = 0, i = o.length; r < i; r++)
              I(o[r], a[r]);
          if (t)
            if (n)
              for (
                o = o || x(e), a = a || x(s), r = 0, i = o.length;
                r < i;
                r++
              )
                _(o[r], a[r]);
          ...
          return (
            (a = x(s, "script")),
            a.length > 0 && T(a, !c && x(e, "script")),
            s
          );
        },
        cleanData: function (e) {
          for (
            var t, n, r, i = xe.event.special, o = 0;
            void 0 !== (n = e[o]);
            o++
          )
            if (Re(n)) {
        ...
        xe.each(
          ...
          function (e, t) {
            xe.fn[e] = function (e) {
              for (
                var n, r = [], i = xe(e), o = i.length - 1, a = 0;
                a <= o;
                a++
              )
      ...
      xe.extend({
          ...
          if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            ...
            if (
              ...
              return a && "get" in a && void 0 !== (i = a.get(e, !1, r))
                ? i
                : u[t];
            (o = void 0 === n ? "undefined" : _typeof(n)),
              "string" === o &&
                (i = ze.exec(n)) &&
                i[1] &&
                ((n = v(e, t, i)), (o = "number")),
        ...
        (xe.cssHooks.marginLeft = L(
          me.reliableMarginLeft,
          function (e, t) {
            if (t)
              return (
      ...
      xe.fn.extend({
        attr: function (e, t) {
          return De(this, xe.attr, e, t, arguments.length > 1);
        },
              ...
              return void 0 === e.getAttribute
                ...
                : ((1 === o && xe.isXMLDoc(e)) ||
                  ...
                  void 0 !== n
                    ...
                    ? r
                    : ((r = xe.find.attr(e, t)), null == r ? void 0 : r));
          },
          attrHooks: {
            type: {
              set: function (e, t) {
        ...
        (xt = {
          set: function (e, t, n) {
            return (
              !1 === t ? xe.removeAttr(e, n) : e.setAttribute(n, n), n
            );
          },
        }),
      ...
      xe.fn.extend({
        prop: function (e, t) {
          return De(this, xe.prop, e, t, arguments.length > 1);
        },
          ...
          propHooks: {
            tabIndex: {
              get: function (e) {
                ...
                return t
                  ? parseInt(t, 10)
                  : St.test(e.nodeName) || (Ot.test(e.nodeName) && e.href)
                  ? 0
                  : -1;
              },
            },
        ...
        val: function (e) {
            ...
            i = this[0];
          {
            if (arguments.length)
              return (
                ...
                this.each(function (n) {
                  var i;
                  1 === this.nodeType &&
                    ((i = r ? e.call(this, n, xe(this).val()) : e),
                    null == i
                      ? (i = "")
                      : "number" == typeof i
                      ? (i += "")
            ...
            if (i)
              return (t =
                xe.valHooks[i.type] ||
                xe.valHooks[i.nodeName.toLowerCase()]) &&
                "get" in t &&
            ...
            select: {
              ...
              set: function (e, t) {
                for (
                  ...
                  (r = i[a]),
                    (r.selected =
                      xe.inArray(xe.valHooks.option.get(r), o) > -1) &&
                      (n = !0);
            ...
            3 !== r.nodeType &&
              ...
              (t = t[xe.expando]
                ...
                : new xe.Event(
                    h,
                    "object" ===
                      (void 0 === t ? "undefined" : _typeof(t)) && t
                  )),
              (t.isTrigger = i ? 2 : 3),
              (t.namespace = y.join(".")),
          ...
          ajax: function (t, n) {
            function r(t, n, r, s) {
              ...
              l ||
                ...
                (S.statusText = (n || T) + ""),
                u
                  ? m.resolveWith(y, [p, T, S])
                  : m.rejectWith(y, [S, T, d]),
                S.statusCode(b),
                (b = void 0),
                f &&
            ...
            var i,
              ...
              y = h.context || h,
              g =
                h.context && (y.nodeType || y.jquery) ? xe(y) : xe.event,
              m = xe.Deferred(),
            ...
            (f = xe.event && h.global),
              ...
              h.ifModified &&
                ...
                xe.etag[o] &&
                  S.setRequestHeader("If-None-Match", xe.etag[o])),
            ...
            if (h.beforeSend && (!1 === h.beforeSend.call(y, S, h) || l))
              return S.abort();
            if (
              ((T = "abort"),
              v.add(h.complete),
      ...
      xe.ajaxSetup({
        ...
        xe.ajaxPrefilter("json jsonp", function (t, n, r) {
          ...
          if (s || "jsonp" === t.dataTypes[0])
            return (
              (i = t.jsonpCallback = ve(t.jsonpCallback)
                ? t.jsonpCallback()
                : t.jsonpCallback),
              s
              ...
              r.always(function () {
                void 0 === o ? xe(e).removeProp(i) : (e[i] = o),
                  t[i] &&
                    ((t.jsonpCallback = n.jsonpCallback), Xt.push(i)),
                  a && ve(o) && o(a[0]),
                  (a = o = void 0);
              }),
              "script"
            ...
            a.length > 0 &&
              xe
                ...
                .done(function (e) {
                  (o = arguments),
                    a.html(
                      r ? xe("<div>").append(xe.parseHTML(e)).find(r) : e
                    );
                })
                .always(
                  n &&
        ...
        xe.each(["top", "left"], function (e, t) {
          xe.cssHooks[t] = L(me.pixelPosition, function (e, n) {
            if (n)
              return (
                (n = D(e, t)), ct.test(n) ? xe(e).position()[t] + "px" : n
              );
          });
        }),
     ...
     */ (function (e, t) {
      ...
      var e,
        ...
        m =
          "function" == typeof /abc/
            ? function (e) {
                return (
                  "function" == typeof e && "[object Function]" === g(e)
                );
              }
            : function (e) {
        ...
        O = Function.apply.bind(Array.prototype.indexOf),
        j = Function.call.bind(Array.prototype.concat),
        k = Function.call.bind(String.prototype.slice),
      ...
      var ne = x.Reflect,
        ...
        ae = {
          ...
          IsIterable: function (e) {
            return ae.TypeIsObject(e) && (void 0 !== e[te] || Z(e));
          },
          GetIterator: function (t) {
            if (Z(t)) return new e(t, "value");
            var n = ae.GetMethod(t, te);
            if (!ae.IsCallable(n))
              throw new TypeError("value is not an iterable");
            var r = ae.Call(n, t);
            if (!ae.TypeIsObject(r)) throw new TypeError("bad iterator");
            return r;
          },
          ...
          IteratorNext: function (e) {
            ...
            if (!ae.TypeIsObject(t)) throw new TypeError("bad iterator");
            return t;
          },
      ...
      if (c && ee) {
        ...
        if (!Q.symbol(z.split)) {
          ...
          var ge = function (e, t) {
            ...
            return ae.Call(ye, n, [ae.ToString(e), t]);
          };
          K(String.prototype, "split", ge);
        }
        var me = Q.symbol(z.match),
          ve =
            me &&
            (function () {
              var e = {};
        ...
        if (!me || ve) {
          var be = se("match"),
            we = String.prototype.match;
          h(RegExp.prototype, be, function (e) {
            return ae.Call(we, e, [this]);
          });
          var xe = function (e) {
            var t = ae.RequireObjectCoercible(this);
            if (!oe(e)) {
              var n = ae.GetMethod(e, be);
              if (void 0 !== n) return ae.Call(n, e, [t]);
            }
            return ae.Call(we, t, [ae.ToString(e)]);
          };
          K(String.prototype, "match", xe);
        }
      }
      var Te = function (e, t, n) {
          v.preserveToString(t, e),
            Object.setPrototypeOf && Object.setPrototypeOf(e, t),
            c
              ? l(Object.getOwnPropertyNames(e), function (r) {
                  r in R || n[r] || v.proxy(e, r, t);
                })
              : l(Object.keys(e), function (r) {
                  r in R || n[r] || (t[r] = e[r]);
                }),
            (t.prototype = e.prototype),
            v.redefine(e.prototype, "constructor", t);
        },
        Se = function () {
          return this;
        },
        Oe = function (e) {
          c && !q(e, W) && v.getter(e, W, Se);
        },
        je = function (e, t) {
          var n =
            t ||
          ...
          h(e, te, n), !e[te] && Q.symbol(te) && (e[te] = n);
        },
        ke = function (e, t, n) {
          c
            ? Object.defineProperty(e, t, {
        ...
        Ae = function (e, t, n) {
          if ((ke(e, t, n), !ae.SameValue(e[t], n)))
      ...
      if (String.fromCodePoint && 1 !== String.fromCodePoint.length) {
        var Ee = String.fromCodePoint;
        K(String, "fromCodePoint", function (e) {
          return ae.Call(Ee, this, arguments);
        });
      }
      var Ne = {
        fromCodePoint: function (e) {
          for (var t, n = [], r = 0, i = arguments.length; r < i; r++) {
            if (
              ...
              !ae.SameValue(t, ae.ToInteger(t)) || t < 0 || t > 1114111)
            )
              throw new RangeError("Invalid code point " + t);
            t < 65536
              ? A(n, String.fromCharCode(t))
              : ((t -= 65536),
                A(n, String.fromCharCode(55296 + (t >> 10))),
                A(n, String.fromCharCode((t % 1024) + 56320)));
          }
          return n.join("");
        },
        raw: function (e) {
      ...
      var _e = function e(t, n) {
        ...
        Ie = {
          ...
          startsWith: function (e) {
            ...
            var i = N(ae.ToInteger(n), 0);
            return k(t, i, i + r.length) === r;
          },
          endsWith: function (e) {
            var t = ae.ToString(ae.RequireObjectCoercible(this));
            if (ae.IsRegExp(e))
      ...
      if (
        (String.prototype.includes &&
          !1 !== "a".includes("a", 1 / 0) &&
          K(String.prototype, "includes", Ie.includes),
        ...
        (Pe && Me) ||
          (K(String.prototype, "startsWith", Ie.startsWith),
          K(String.prototype, "endsWith", Ie.endsWith));
      }
      if (ee) {
        a(function () {
          var e = /a/;
      ...
      y(String.prototype, Ie);
      var De = [
          "\t\n\v\f\r \xa0\u1680\u180e\u2000\u2001\u2002\u2003",
          "\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028",
          "\u2029\ufeff",
        ].join(""),
        Le = new RegExp("(^[" + De + "]+)|([" + De + "]+$)", "g"),
        qe = function () {
          return ae
        ...
        Fe = new RegExp("[" + Re + "]", "g"),
        He = /^[-+]0x[0-9a-f]+$/i,
        Ve = Re.trim().length !== Re.length;
      h(String.prototype, "trim", qe, Ve);
      var $e = function (e) {
      ...
      var ze = {
        from: function (e) {
          ...
          var a,
            s,
            c,
            u = void 0 !== (Z(e) || ae.GetMethod(e, te));
          if (u) {
            ...
            var l,
              ...
              p = ae.GetIterator(e);
            for (c = 0; ; ) {
              if (!1 === (l = ae.IteratorStep(p))) break;
              f = l.value;
              try {
                i && (f = void 0 === o ? t(f, c) : n(t, o, f, c)),
                  (s[c] = f);
              } catch (e) {
                throw (ae.IteratorClose(p, !0), e);
              }
              c += 1;
            }
            a = c;
            ...
            var d = ae.ToObject(e);
            (a = ae.ToLength(d.length)),
              (s = ae.IsConstructor(r) ? Object(new r(a)) : new Array(a));
            var h;
            for (c = 0; c < a; ++c)
              (h = d[c]),
                i && (h = void 0 === o ? t(h, c) : n(t, o, h, c)),
                Ae(s, c, h);
          }
          return (s.length = a), s;
        },
      ...
      var We = {
        ...
        find: function (e) {
          ...
          for (
            var i, o = arguments.length > 1 ? arguments[1] : null, a = 0;
            a < r;
            a++
          )
            if (((i = t[a]), o)) {
      ...
      if (
        ...
        Array.prototype.keys &&
          ...
          Array.prototype[te] &&
          (y(Array.prototype, { values: Array.prototype[te] }),
          Q.symbol(z.unscopables) &&
            (Array.prototype[z.unscopables].values = !0)),
        u &&
          Array.prototype.values &&
        ...
        K(Array.prototype, "values", function () {
          return ae.Call(Ue, this, arguments);
        }),
          h(Array.prototype, te, Array.prototype.values, !0);
      }
      y(Array.prototype, We),
        1 / [!0].indexOf(!0, -0) < 0 &&
          h(
            Array.prototype,
            "indexOf",
        ...
        var ct = Number,
          ...
          dt = function (e) {
            ...
            if (
              ...
              ((t = e.valueOf()), Q.primitive(t))
            )
              return t;
            if (
              "function" == typeof e.toString &&
              ((t = e.toString()), Q.primitive(t))
            )
              return t;
      ...
      y(Number, {
        ...
        isSafeInteger: function (e) {
          return Number.isInteger(e) && P(e) <= Number.MAX_SAFE_INTEGER;
        },
        isNaN: U,
      }),
        h(Number, "parseInt", x.parseInt, Number.parseInt !== x.parseInt),
        1 ===
          [, 1].find(function () {
            return !0;
          }) && K(Array.prototype, "find", We.find),
        0 !==
          [, 1].findIndex(function () {
            return !0;
          }) && K(Array.prototype, "findIndex", We.findIndex);
      var vt = Function.bind.call(
          Function.bind,
        ...
        Tt = function (e, t) {
          ...
          return (
            ae.IsCallable(Object.getOwnPropertySymbols) &&
              (n = p(Object.getOwnPropertySymbols(Object(t)), vt(t))),
            f(j(r, n || []), xt(t), e)
          );
        },
        St = {
          assign: function (e, t) {
            ...
            return f(ae.Call(wt, 1, arguments), Tt, n);
          },
          is: function (e, t) {
      ...
      if (
        ...
        var Ot = {
          setPrototypeOf: (function (e, t) {
            ...
            try {
              (r = e.getOwnPropertyDescriptor(e.prototype, "__proto__")
                .set),
                n(r, {}, null);
            } catch (t) {
      ...
      if (Object.getOwnPropertyNames) {
        if (
          ...
          K(Object, "getOwnPropertyNames", function (e) {
            var t = ae.ToObject(e);
      ...
      if (Object.getOwnPropertyDescriptor) {
        if (
          ...
          K(Object, "getOwnPropertyDescriptor", function (e, t) {
            return Et(ae.ToObject(e), t);
          });
        }
      }
      if (Object.seal) {
      ...
      if (Object.isSealed) {
        if (
          ...
          var _t = Object.isSealed;
          K(Object, "isSealed", function (e) {
            return !ae.TypeIsObject(e) || _t(e);
          });
        }
      }
      if (Object.freeze) {
        if (
          ...
          K(Object, "freeze", function (e) {
            return ae.TypeIsObject(e) ? It(e) : e;
          });
        }
      }
      if (Object.isFrozen) {
        if (
          ...
          var Pt = Object.isFrozen;
          K(Object, "isFrozen", function (e) {
            return !ae.TypeIsObject(e) || Pt(e);
          });
        }
      }
      if (Object.preventExtensions) {
        if (
          ...
          K(Object, "preventExtensions", function (e) {
            return ae.TypeIsObject(e) ? Mt(e) : e;
          });
        }
      }
      if (Object.isExtensible) {
        if (
          ...
          K(Object, "isExtensible", function (e) {
            return !!ae.TypeIsObject(e) && Dt(e);
          });
        }
      }
      if (Object.getPrototypeOf) {
        if (
          ...
          K(Object, "getPrototypeOf", function (e) {
            return Lt(ae.ToObject(e));
          });
        }
      }
      var qt =
      ...
      if (c && !qt) {
        ...
        v.getter(RegExp.prototype, "flags", Rt);
      }
      var Ft =
          c &&
          a(function () {
      ...
      if (!Vt || !$t) {
        var Bt = RegExp.prototype.toString;
        h(
          RegExp.prototype,
          "toString",
          function () {
          ...
          v.preserveToString(RegExp.prototype.toString, Bt);
      }
      if (c && (!Ft || Ht)) {
        var zt = Object.getOwnPropertyDescriptor(
          ...
          Gt = ae.IsCallable(Wt.get) ? Wt.get : Ut,
          Xt = RegExp,
          Yt = (function () {
            return function e(t, n) {
              ...
              return Q.regex(t)
                ? ((i = ae.Call(Gt, t)),
                  (o = void 0 === n ? ae.Call(zt, t) : n),
                  new e(i, o))
                : (r &&
                    ((i = t.source), (o = void 0 === n ? t.flags : n)),
                  new Xt(t, n));
            };
          })();
        Te(Xt, Yt, { $input: !0 }),
          (RegExp = Yt),
          v.redefine(x, "RegExp", Yt);
      }
      if (c) {
        var Jt = {
          input: "$_",
        ...
        l(i(Jt), function (e) {
          e in RegExp &&
            !(Jt[e] in RegExp) &&
            v.getter(RegExp, Jt[e], function () {
              return RegExp[e];
            });
        });
      }
      Oe(RegExp);
      var Zt = 1 / Number.EPSILON,
        Qt = function (e) {
          return e + Zt - Zt;
        },
        Kt = Math.pow(2, -23),
        en = Math.pow(2, 127) * (2 - Kt),
        tn = Math.pow(2, -126),
        nn = Math.E,
        rn = Math.LOG2E,
        on = Math.LOG10E,
      ...
      var sn = {
        ...
        tanh: function (e) {
          ...
          return U(t) || 0 === t
            ...
            : t <= -20
            ? -1
            : (Math.expm1(t) - Math.expm1(-t)) / (M(t) + M(-t));
        },
        trunc: function (e) {
          var t = Number(e);
          return t < 0 ? -I(-t) : I(t);
        ...
        fround: function (e) {
          ...
          var n = X(t),
            r = P(t);
          if (r < tn) return n * Qt(r / tn / Kt) * tn * Kt;
          var i = (1 + Kt / Number.EPSILON) * r,
            o = i - (i - r);
          return o > en || U(o) ? n * (1 / 0) : n * o;
        },
      };
      y(Math, sn),
      ...
      var cn = Math.expm1(10);
      h(
        Math,
        "expm1",
        sn.expm1,
        cn > 22025.465794806718 || cn < 22025.465794806718
      );
      var un = Math.round,
        ln =
      ...
      h(
        ...
        v.preserveToString(Math.round, un);
      var hn = Math.imul;
      -5 !== Math.imul(4294967295, 5) &&
        ((Math.imul = sn.imul), v.preserveToString(Math.imul, hn)),
        2 !== Math.imul.length &&
          K(Math, "imul", function (e, t) {
      ...
      var yn = (function () {
        ...
        if (
          ...
          var t,
            r = function (e) {
              ...
              if (
                ...
                (t.reject = void 0),
                (t.promise = new e(n)),
                !ae.IsCallable(t.resolve) || !ae.IsCallable(t.reject))
              )
                throw new TypeError("Bad promise constructor");
            };
          "undefined" != typeof window &&
          ...
          var i,
            o,
            a = ae.IsCallable(x.setImmediate)
              ? x.setImmediate
              : "object" ===
            ...
            p = function (e, t) {
              ...
              if (
                r > 0 &&
                (l(n.fulfillReactionHandler0, n.reactionCapability0, t),
            ...
            d = function (e, t) {
              ...
              if (
                r > 0 &&
                (l(n.rejectReactionHandler0, n.reactionCapability0, t),
                (n.fulfillReactionHandler0 = void 0),
                (n.rejectReactions0 = void 0),
                (n.reactionCapability0 = void 0),
                r > 1)
            ...
            h = function (e) {
              ...
              return {
                resolve: function (n) {
                  ...
                  if (!t) {
                    if (((t = !0), n === e))
                      return d(e, new TypeError("Self resolution"));
                    if (!ae.TypeIsObject(n)) return p(e, n);
                    try {
                      r = n.then;
                    } catch (t) {
                      return d(e, t);
                    }
                    if (!ae.IsCallable(r)) return p(e, n);
                    a(function () {
                      m(e, n, r);
                    });
                  }
          ...
          var b = function (e, t, n, r) {
            ...
            w = function (e, t, n) {
              for (
                var r, i, o = e.iterator, a = [], s = { count: 1 }, c = 0;
                ;
                ...
                var u = t.resolve(i),
                  l = b(c, a, n, s);
                (s.count += 1), g(u.then, u, l, n.reject), (c += 1);
              }
              if (0 == --s.count) {
                (0, n.resolve)(a);
              }
            ...
            T = function (e, t, n) {
              for (var r, i, o, a = e.iterator; ; ) {
                ...
                (o = t.resolve(i)), g(o.then, o, n.resolve, n.reject);
              }
              return n.promise;
            };
          return (
            ...
            y(i, {
              ...
              then: function (e, t) {
                ...
                var i,
                  o = ae.SpeciesConstructor(n, v);
                i =
                  arguments.length > 2 && arguments[2] === u && o === v
                    ? u
                    : new r(o);
                var a,
                  f = ae.IsCallable(e) ? e : s,
                  p = ae.IsCallable(t) ? t : c,
                  d = n._promise;
                if (0 === d.state) {
                  if (0 === d.reactionLength)
                    (d.fulfillReactionHandler0 = f),
                      (d.rejectReactionHandler0 = p),
                      (d.reactionCapability0 = i);
                  else {
      ...
      if (
        ...
        (xn.prototype = Promise.prototype), (xn.all = Promise.all);
        var Tn = a(function () {
          return !!xn.all([1, 2]);
        });
        if (
          ((gn && mn && vn && !bn && wn && !Tn) ||
            ((Promise = yn), K(x, "Promise", yn)),
          1 !== Promise.all.length)
        ) {
          var Sn = Promise.all;
          K(Promise, "all", function (e) {
            return ae.Call(Sn, this, arguments);
          });
        }
        if (1 !== Promise.race.length) {
          var On = Promise.race;
          K(Promise, "race", function (e) {
            return ae.Call(On, this, arguments);
          });
        }
        if (1 !== Promise.resolve.length) {
          var jn = Promise.resolve;
          K(Promise, "resolve", function (e) {
            return ae.Call(jn, this, arguments);
          });
        }
        if (1 !== Promise.reject.length) {
          var kn = Promise.reject;
          K(Promise, "reject", function (e) {
            return ae.Call(kn, this, arguments);
          });
        }
        bt(Promise, "all"),
          bt(Promise, "race"),
              ...
              var a,
                s = function e() {
                  ...
                  return (
                    (r.next = r.prev = r),
                    (n._head = r),
                    arguments.length > 0 && In(e, n, arguments[0]),
                    n
                  );
                };
              return (
                (a = s.prototype),
                v.getter(a, "size", function () {
                ...
                y(a, {
                  get: function (e) {
                    ...
                    if (this._map)
                      return (
                        (t = V.call(this._map, e)), t ? t.value : void 0
                      );
                    for (var r = this._head, o = r; (o = o.next) !== r; )
                      if (ae.SameValueZero(o.key, e)) return o.value;
                  },
                  has: function (e) {
                    i(this, "has");
                    var t = Nn(e, !0);
                    ...
                    for (var n = this._head, r = n; (r = r.next) !== n; )
                      if (ae.SameValueZero(r.key, e)) return !0;
                    return !1;
                  },
                  set: function (e, n) {
                    i(this, "set");
                    ...
                    if (null !== s) {
                      ...
                      this._map &&
                        ($.call(this._map, e)
                          ? (V.call(this._map, e).value = n)
                          : ((r = new t(e, n)),
                            B.call(this._map, e, r),
                            (a = o.prev)));
                    for (; (a = a.next) !== o; )
                  ...
                  forEach: function (e) {
                    ...
                    for (
                      ...
                      t
                        ? n(e, t, o.value[1], o.value[0], this)
            ...
            Set: (function () {
              var e,
                ...
                o = function t() {
                  ...
                  return (
                    arguments.length > 0 && Pn(t, n, arguments[0]), n
                  );
                };
              e = o.prototype;
              var a = function (e) {
              ...
              return (
                ...
                y(o.prototype, {
                  has: function (e) {
                    r(this, "has");
                    var t;
                    return this._storage && null !== (t = Nn(e))
                      ? !!this._storage[t]
                  ...
                  clear: function () {
                    r(this, "clear"),
                      this._storage && (this._storage = _n()),
                  ...
                  forEach: function (e) {
                    ...
                    var t = arguments.length > 1 ? arguments[1] : null,
                      i = this;
                    s(i),
                      this["[[SetData]]"].forEach(function (r, o) {
                        t ? n(e, t, o, o, i) : e(o, o, i);
                      });
                  },
                }),
                h(o.prototype, "keys", o.prototype.values, !0),
                je(o.prototype, o.prototype.values),
                o
              );
            })(),
          };
        if (x.Map || x.Set) {
          a(function () {
            ...
            ((x.Map = function e() {
              ...
              var t = new F();
              return (
                arguments.length > 0 && In(e, t, arguments[0]),
                delete t.constructor,
                Object.setPrototypeOf(t, x.Map.prototype),
                t
              );
            }),
            (x.Map.prototype = b(F.prototype)),
            h(x.Map.prototype, "constructor", x.Map, !0),
            v.preserveToString(x.Map, F));
          var Dn = new Map(),
            Ln = (function () {
              var e = new Map([
                [1, 0],
            ...
            qn = Dn.set(1, 2) === Dn;
          (Ln && qn) ||
            K(Map.prototype, "set", function (e, t) {
            ...
            Ln ||
              ...
              v.preserveToString(Map.prototype.get, V),
              v.preserveToString(Map.prototype.has, $));
          var Rn = new Set(),
            Fn = (function (e) {
          ...
          if (!Fn || !Hn) {
            ...
            (Set.prototype.add = function (e) {
              ...
              v.preserveToString(Set.prototype.add, Vn);
          }
          if (!Fn) {
            var $n = Set.prototype.has;
            (Set.prototype.has = function (e) {
              return n($n, this, 0 === e ? 0 : e);
            }),
              v.preserveToString(Set.prototype.has, $n);
            var Bn = Set.prototype.delete;
            (Set.prototype.delete = function (e) {
              return n(Bn, this, 0 === e ? 0 : e);
            }),
              v.preserveToString(Set.prototype.delete, Bn);
          }
          var zn = w(x.Map, function (e) {
              var t = new e([]);
              return t.set(42, 42), t instanceof e;
            }),
            Wn = Object.setPrototypeOf && !zn,
            Un = (function () {
              try {
          ...
          (0 === x.Map.length && !Wn && Un) ||
            ...
            (x.Map.prototype = F.prototype),
            h(x.Map.prototype, "constructor", x.Map, !0),
            v.preserveToString(x.Map, F));
          var Gn = w(x.Set, function (e) {
              var t = new e([]);
          ...
          if (0 !== x.Set.length || Xn || !Yn) {
            ...
            (x.Set = function e() {
              ...
              var t = new Jn();
              return (
                arguments.length > 0 && Pn(e, t, arguments[0]),
                delete t.constructor,
                Object.setPrototypeOf(t, e.prototype),
                t
              );
            }),
              (x.Set.prototype = Jn.prototype),
              h(x.Set.prototype, "constructor", x.Set, !0),
              v.preserveToString(x.Set, Jn);
          }
          var Zn = new x.Map(),
            Qn = !a(function () {
          ...
          if (
            (("function" != typeof x.Map.prototype.clear ||
              ...
              s(x.Map) ||
              s(x.Set) ||
              "function" != typeof Zn.keys().next ||
              Qn ||
              !zn) &&
              y(x, { Map: Mn.Map, Set: Mn.Set }, !0),
            x.Set.prototype.keys !== x.Set.prototype.values &&
              h(x.Set.prototype, "keys", x.Set.prototype.values, !0),
            je(Object.getPrototypeOf(new x.Map().keys())),
            je(Object.getPrototypeOf(new x.Set().keys())),
            u && "has" !== x.Set.prototype.has.name)
          ) {
            var Kn = x.Set.prototype.has;
            K(x.Set.prototype, "has", function (e) {
              return n(Kn, this, e);
            });
          }
        }
        y(x, Mn), Oe(x.Map), Oe(x.Set);
      }
      var er = function (e) {
          if (!ae.TypeIsObject(e))
      ...
      var sr = function (e, t) {
        if (ae.IsCallable(x.Reflect[e])) {
          a(function () {
            return (
              x.Reflect[e](1), x.Reflect[e](NaN), x.Reflect[e](!0), !0
            );
          }) && K(x.Reflect, e, t);
      ...
      var cr = x.Reflect.getPrototypeOf;
      if (
        (u &&
          cr &&
          "getPrototypeOf" !== cr.name &&
          K(x.Reflect, "getPrototypeOf", function (e) {
            return n(cr, x.Reflect, e);
          }),
        x.Reflect.setPrototypeOf &&
          a(function () {
            return x.Reflect.setPrototypeOf(1, {}), !0;
          }) &&
          K(x.Reflect, "setPrototypeOf", tr.setPrototypeOf),
        x.Reflect.defineProperty &&
          (a(function () {
            var e = !x.Reflect.defineProperty(1, "test", { value: 1 }),
              t =
            ...
            K(x.Reflect, "defineProperty", tr.defineProperty)),
        x.Reflect.construct &&
          (a(function () {
            var e = function () {};
            return (
              x.Reflect.construct(function () {}, [], e) instanceof e
            );
          }) ||
            K(x.Reflect, "construct", tr.construct)),
      ...
      l(Object.keys(fr), function (e) {
        var t = String.prototype[e],
          r = !1;
        if (ae.IsCallable(t)) {
          var i = n(t, "", ' " '),
            o = j([], i.match(/"/g)).length;
          r = i !== i.toLowerCase() || o > 2;
        } else r = !0;
        r && K(String.prototype, e, fr[e]);
      });
      var pr = (function () {
          if (!ee) return !1;
          var e =
            "object" ===
              ("undefined" == typeof JSON
                ? "undefined"
                : _typeof(JSON)) && "function" == typeof JSON.stringify
              ? JSON.stringify
              : null;
          if (!e) return !1;
          if (void 0 !== e(z())) return !0;
        ...
        dr = a(function () {
          return (
            !ee ||
            ("{}" === JSON.stringify(Object(z())) &&
              "[{}]" === JSON.stringify([Object(z())]))
          );
        });
      if (pr || !dr) {
        var hr = JSON.stringify;
        K(JSON, "stringify", function (e) {
            ...
            if (r(t)) i.push(t);
              ...
              var o = ae.IsCallable(t) ? t : null,
                a = function (e, t) {
                  ...
                  if (
                    "symbol" !== (void 0 === r ? "undefined" : _typeof(r))
                  )
                    return Q.symbol(r) ? xt({})(r) : r;
                };
              i.push(a);
            }
            return (
    ...
    define("jqueryplugins", ["jquery"], function (e) {
      e.prototype.extend({
        ...
        textNodes: function () {
          return 1 === this.length && this[0] instanceof Text
            ? [this[0]]
            : Array.from(
                this.add(
                  this.contents().add(this.find("*").contents())
                ).filter(function () {
    ...
    function () {
        ...
        return !(
          ...
          (e.cannotFollow &&
            (-1 !== e.cannotFollow.indexOf(n && n.type) ||
              (e.cannotFollow.indexOf("text") > -1 && r))) ||
          (e.peek &&
            e.peek.toLowerCase() !==
              t.slice(0, e.peek.length).toLowerCase())
        );
      }
      function r(e) {
        for (
          ...
          for (
            ...
            if (n(h, l, u, s < o) && h.pattern.test(l)) {
              ...
              s < o &&
                ...
                (o += u.text.length),
                (s = o),
                m && (i(e, u, r[v]), (r = r.slice(v + 1))),
                u.isFrontToken() && r.unshift(u);
              break;
            }
          }
          p === d && ((o += 1), null === u && (u = { type: "text" }));
        }
        for (
          s < o &&
          e.addChild({
      ...
      function i(e, n, r) {
        ...
        (n.children = e.children.splice(o + 1, i - (o + 1))),
          n.children.forEach(function (e) {
            t(n, e);
          }),
          (n.type = n.matches[r.type]),
          (n.innerText = "");
        for (var a = 0, s = n.children.length; a < s; a++)
          n.innerText += n.children[a].text;
        (n.start = r.start),
          (n.text = r.text + n.innerText + n.text),
      ...
      (e.prototype = {
        ...
        addChild: function (n) {
          ...
          return (
            o.innerText && r(o), this.children.push(o), t(this, o), o
          );
        },
        lastChild: function () {
        ...
        tokenAt: function (e) {
          ...
          if (this.childAt)
            return (
              (this.childAt[e] && this.childAt[e].tokenAt(e)) || this
            );
      ...
      var n = void 0,
        ...
        b = {
          ...
          text:
            ...
            (function () {
              return (
                "[^" + Array.apply(0, arguments).map(e).join("") + "]*"
              );
            })("]") +
            ")",
          rightSeparator: r("\\->", "\\|"),
    ...
    function () {
      function e(e) {
        ...
        var u = i(a, {
            ...
            boldOpener: { fn: r("boldOpener", "bold") },
            italicOpener: { fn: r("italicOpener", "italic") },
            strikeOpener: { fn: r("strikeOpener", "strike") },
            supOpener: { fn: r("supOpener", "sup") },
            commentFront: {
              fn: function () {
                return { isFront: !0 };
              },
            ...
            verbatimOpener: {
              fn: function (e) {
                var t = e[0].length,
                  n = {};
                return (
                  (n["verbatim" + t] = "verbatim"),
                  { type: "verbatim" + t, isFront: !0, matches: n }
                );
              },
            },
            collapsedFront: {
            ...
            Object.assign(
              {
                ...
                itsProperty: { cannotFollow: ["text"], fn: t("name") },
                ...
                colour: {
                  ...
                  fn: function (e) {
                    ...
                    return (
                      (t = Object.hasOwnProperty.call(r, n)
                        ? "#" + r[n]
                        : n),
                      { colour: t }
                    );
                ...
                identifier: { fn: t("name"), cannotFollow: ["text"] },
              ...
              [
                ...
                return (e[t] = { fn: o, cannotFollow: ["text"] }), e;
              }, {}),
              [
                "comma",
                "spread",
        ...
        a.push.apply(
          a,
          _toConsumableArray(Object.keys(c)).concat(
            _toConsumableArray(Object.keys(l)),
            _toConsumableArray(Object.keys(u))
          )
        ),
          s.push.apply(
            s,
            _toConsumableArray(Object.keys(l)).concat(
              _toConsumableArray(Object.keys(f))
            )
          );
          ...
          Object.keys(p).forEach(function (e) {
            ...
            (p[e].pattern =
              "string" != typeof t
                ? t
                : new RegExp("^(?:" + t + ")", "i")),
              n[e + "Peek"] && (p[e].peek = n[e + "Peek"]);
          }),
          Object.assign(e.rules, p),
          (e.modes.start = e.modes.markup = a),
          (e.modes.macro = s),
          e
        );
      }
      function t(t) {
        return Object.freeze({ lex: e(t).lex, Patterns: n });
      }
      var n = void 0;
      (Object.assign =
        Object.assign ||
        ...
        ("undefined" == typeof module ? "undefined" : _typeof(module))
          ? ((n = require("./patterns")),
            (module.exports = t(require("./lexer"))))
          : "function" == typeof define && define.amd
          ? define("markup", ["lexer", "patterns"], function (e, r) {
              return (n = r), t(e);
            })
          : this && this.loaded && this.modules
          ? ((n = this.modules.Patterns),
            (this.modules.Markup = t(this.modules.Lexer)))
          : ((n = this.Patterns),
            (this.TwineMarkup = t(this.TwineLexer)));
    }.call(
      eval("this") || ("undefined" != typeof global ? global : window)
    ),
        ...
        (e.includes = function (t) {
          var n =
            arguments.length > 1 && void 0 !== arguments[1]
              ? arguments[1]
              : 0;
          if (!Number.isNaN(t) && Number.isFinite(n) && void 0 !== t)
            return e.indexOf.call(this, t, n) > -1;
          var r = Object(this),
            i = parseInt(r.length);
          if (i <= 0) return !1;
      ...
      function r(t, n) {
        ...
        if (!r[t]) {
          var i = e("<p>")
            ...
            .addClass(n);
          (r[t] =
            u.cssTimeUnit(i.css("animation-duration")) +
            u.cssTimeUnit(i.css("animation-delay"))),
            i.remove();
        }
        return r[t];
      }
      var i = { configurable: 0, writable: 0 },
        o = {
        ...
        (u = {
          ...
          toJSLiteral: function (e) {
            return e instanceof Map
              ? "(new Map(" +
                  u.toJSLiteral(
                    [].concat(_toConsumableArray(e.entries()))
                  ) +
                  "))"
              : e instanceof Set
              ? "(new Set(" +
                u.toJSLiteral([].concat(_toConsumableArray(e.values()))) +
                "))"
              : JSON.stringify(e);
          },
          ...
          childrenProbablyInline: function (e) {
            var t = [];
            return (
              Array.prototype.every.call(e.find("*"), function (e) {
                return (
                  !(!e.hidden && !/none|inline/.test(e.style.display)) ||
                  (!a.includes(e.tagName.toLowerCase()) &&
          ...
          transitionReplace: function (t, r, i) {
            ...
            o.length > 0 && (t = o);
            var a = e("<tw-transition-container>").css(
              "position",
              "relative"
            );
            ...
            var s = void 0;
            r &&
              ((s = e("<tw-transition-container>").appendTo(a)),
              r.appendTo(s));
            var c = e("<tw-transition-container>")
              .css("position", "absolute")
              .prependTo(a);
            t.detach().appendTo(c),
              u.transitionOut(c, i),
              r &&
                u.transitionIn(s, i, function () {
          ...
          transitionOut: function (e, t, n) {
            ...
            (e.length > 1 ||
              !o ||
              !["tw-hook", "tw-passage"].includes(e.tag())) &&
              (e = e.wrapAll("<tw-transition-container>").parent()),
              e.attr("data-t8n", t).addClass("transition-out"),
              u.childrenProbablyInline(e) &&
                e.css("display", "inline-block"),
              "number" == typeof n &&
                e.css("animation-duration", n + "ms");
          ...
          transitionIn: function (e, t, n) {
            function i() {
              ...
              a && t
                ? e.contents().unwrap()
                : e.removeClass("transition-in").removeAttr("data-t8n");
            }
            var o = u.childrenProbablyInline(e),
              a =
                e.length > 1 ||
                !o ||
                !["tw-hook", "tw-passage"].includes(e.tag());
            a && (e = e.wrapAll("<tw-transition-container>").parent()),
              e.attr("data-t8n", t).addClass("transition-in"),
              "number" == typeof n &&
                e.css("animation-duration", n + "ms"),
              u.childrenProbablyInline(e) &&
                e.css("display", "inline-block");
          ...
          $: function (t, n) {
            return e(t, n || u.storyElement).not(
          ...
          assertMustHave: function (e, t) {
            if (window.console)
              for (var n = 0; n < t.length; n += 1)
                t[n] in e ||
                  console.error(
                    "Assertion failed: object lacks property " + t[n]
                  );
          },
          assertOnlyHas: function (e, t) {
            if (window.console)
              for (var n in e)
                t.includes(n) ||
                  console.error(
                    "Assertion failed: object had unexpected property '" +
                      n +
                      "'!"
                  );
          },
    ...
    define("passages", ["jquery", "utils", "utils/selectors"], function (
      e,
      t,
      n
    ) {
      ...
      return (
        o(function () {
          Array.from(e(n.storyData + " > " + n.passageData)).forEach(
            function (t) {
              (t = e(t)), a.set(t.attr("name"), new r(t));
            }
          );
        }),
        a
    ...
    define("datatypes/hookset", [
      ...
      function o(e, t) {
        ...
        for (; e.length > 0; ) {
          ...
          if (s > -1) {
            for (
              var c, u = r.length - (s + t.length);
              s >= n[0].textContent.length;

            )
              (s -= n[0].textContent.length), n.shift();
            if (1 === n.length) {
              var l = i(n[0], s, s + t.length);
              a.push(l[0]), l[1] && e.unshift(l[1]);
              break;
            }
            a.push(i(n[0], s, n[0].length)[0]),
              (c = a).push.apply(c, _toConsumableArray(n.slice(1, -1)));
            var f = i(
              n[n.length - 1],
              0,
              n[n.length - 1].textContent.length - u
            );
            a.push(f[0]),
              f[1] && e.unshift(f[1]),
              (a = a.filter(Boolean));
      ...
      function c(n) {
        var r = n.dom,
          i = e();
        this.prev && (i = i.add(c.call(this.prev, { dom: r })));
        var o = function (t, n) {
        ...
        if (this.selector) {
          var u = void 0;
          (u = this.selector.match("^" + f.hookRef + "$")
            ? r
                .add(r.parentsUntil(t.storyElement.parent()))
                .findAndFilter(s(this.selector))
            : a(this.selector, r, "<tw-pseudo-hook>")),
            (i = this.properties.length
              ? i.add(this.properties.reduce(o, u))
              : i.add(u));
        }
        return (
          this.base &&
            (i = i.add(
              this.properties.reduce(o, c.call(this.base, { dom: r }))
            )),
          i
        );
      }
      ...
      function l(e) {
        ...
        return [
          JSON.stringify([
            t.insensitiveName(n) || "",
            l(r),
            [].concat(_toConsumableArray(i)).sort(),
          ]),
        ]
          .concat(_toConsumableArray(l(o)))
          .sort();
      }
      var f = r.Patterns,
        p = Object.freeze({
          ...
          get TwineScript_ObjectName() {
            return this.properties.length > 0 || this.prev
              ? "a complex hook name"
              : this.selector + " (a hook name)";
          },
    ...
    define("internaltypes/twineerror", ["jquery", "utils"], function (
      e,
      t
    ) {
      var n = t.impossible,
        ...
        o = {
          create: function (e, t, r) {
            return (
              t || n("TwineError.create", "called with only 1 string."),
              r ||
                e in i ||
                n("TwineError.create", "no error explanation given"),
            ...
            return t.reduce(function (e, t) {
              return (
                ...
                (t instanceof Error
                  ...
                  ? t
                  : !!Array.isArray(t) &&
                    o.containsError.apply(o, _toConsumableArray(t)))
              );
            }, !1);
          },
          ...
          render: function (t) {
            ...
            var n = e(
                "<tw-error class='" +
                  ("javascript" === this.type ? "javascript " : "") +
              ...
              o = e("<tw-error-explanation>")
                .text(this.explanation || i[this.type])
                .hide(),
              a = e("<tw-error-explanation-button tabindex=0>").html(
                "<span class='folddown-arrowhead'>&#9658;</span>"
              );
            return (
              a.on("click", function () {
                o.toggle(),
                  a
                    .children(".folddown-arrowhead")
                    .css(
                      "transform",
                      "rotate(" +
                        (o.is(":visible") ? "90deg" : "0deg") +
                        ")"
                    );
              }),
              n.append(a).append(o),
              n.data("TwineError", this),
              n
            );
          },
        };
    ...
    define("utils/operationutils", [
      ...
      function a(e, t) {
        if (
          (e instanceof Map ||
            v("isValidDatamapName", "called with non-Map"),
      ...
      function s(e, t) {
        ...
        if (t.innerType) {
          if ("optional" === t.pattern || "zero or more" === t.pattern)
            return void 0 === e || s(e, t.innerType);
          if ("either" === t.pattern)
            return t.innerType.some(function (t) {
              return s(e, t);
            });
          if ("lambda" === t.pattern && s(e, t.innerType))
            return (
              "string" != typeof t.clauses &&
                v(
                  "singleTypeCheck",
                  "lambda signature had non-string clauses"
                ),
              t.clauses.includes("where") === "where" in e &&
                t.clauses.includes("making") === "making" in e &&
                t.clauses.includes("via") === "via" in e &&
                t.clauses.includes("with") === "with" in e
            );
          if ("wrapped" === t.pattern) return s(e, t.innerType);
        }
        return (
          (void 0 === t || void 0 !== e) &&
          (("anything" === t.TwineScript_TypeName &&
            void 0 !== e &&
            !e.TwineScript_Unstorable) ||
            (t === String
              ? "string" == typeof e
              : t === Boolean
              ? "boolean" == typeof e
              ...
              : t === Map || t === Set
              ? e instanceof t
              : Object.isPrototypeOf.call(t, e)))
        );
      }
      function c(e) {
        return (
          "string" == typeof e || Array.isArray(e) || n.isPrototypeOf(e)
        );
      }
      function u(e) {
        if (!i(e)) return e;
        if ("function" == typeof e.TwineScript_Clone)
      ...
      function l(e) {
        return i(e) && "TwineScript_ObjectName" in e
      ...
      function f(e) {
        return Object.getPrototypeOf(e) === Object.prototype &&
          ...
          ? e.typeName
            ? e.typeName
            : "either" === e.pattern
            ? (Array.isArray(e.innerType) ||
                v(
                  "typeName",
                  '"either" pattern had non-array inner type'
                ),
              e.innerType.map(f).join(" or "))
            : "optional" === e.pattern
            ? "(an optional) " + f(e.innerType)
            : f(e.innerType)
          ...
          : e === Array
          ? "an array"
          : i(e) && "TwineScript_TypeName" in e
          ? e.TwineScript_TypeName
          : l(e);
      }
      function p(e, t) {
        return "object" !== (void 0 === e ? "undefined" : _typeof(e)) &&
          ...
          : e && "function" == typeof e.TwineScript_is
          ? e.TwineScript_is(t)
          : e &&
            "object" === (void 0 === e ? "undefined" : _typeof(e)) &&
            t &&
      ...
      function h(e, t) {
        return "function" == typeof t.TwineScript_IsTypeOf
      ...
      function y(e, t) {
        return e && "function" == typeof e.TwineScript_IsTypeOf
          ? e.TwineScript_IsTypeOf(t)
          : t && "function" == typeof t.TwineScript_IsTypeOf
          ? t.TwineScript_IsTypeOf(e)
          : Array.isArray(e) && Array.isArray(t)
          ? e.length === t.length &&
            e.every(function (e, n) {
          ...
          : e instanceof Set && t instanceof Set
          ? ((e = [].concat(_toConsumableArray(e))),
            b.apply(void 0, _toConsumableArray(t)).some(function (t) {
              return y(e, t);
            }))
          : p(e, t);
      }
      function g(e, t, n) {
        if (!t || !n)
          return r.create(
            "macrocall",
            "The sub" + o(e) + " index values must not be 0 or NaN."
          );
        if (
          (t < 0 && (t = e.length + t + 1),
          n < 0 && (n = e.length + n + 1),
      ...
      function m(t) {
        return r.containsError(t)
          ? t
          : t && "function" == typeof t.TwineScript_Print
          ? t.TwineScript_Print()
          : t instanceof Map
    ...
    define("twinescript/compiler", ["utils"], function (e) {
      ...
      function n(e, n) {
        return (
          e.length -
          1 -
          t.apply(void 0, [[].concat(_toConsumableArray(e)).reverse(), n])
        );
      }
      function r(e, r) {
        var i = [];
        return e.length
          ? ([
              ...
              ["most" === r ? "reverse" : "valueOf"]()
              .some(function (r) {
                var o = void 0;
                if (
                  ((o = r.rightAssociative
      ...
      function a(e) {
        ...
        if (((e = [].concat(e)), !e.length))
          return n && u
            ? "TwineError.create('operation'," + s(u) + ")"
            : "";
        var p = e[0];
        if (1 === e.length) {
          if ("identifier" === p.type)
            return n
              ? "VarRef.create(Operations.Identifiers," + s(p.text) + ")"
              : " Operations.Identifiers." + p.text.toLowerCase() + " ";
          if ("variable" === p.type)
            return (
              "VarRef.create(State.variables," +
              s(p.name) +
              ")" +
              (n ? "" : ".get()")
            );
          if ("tempVariable" === p.type)
            return (
              "VarRef.create(section.stack[0].tempVariables," +
              s(p.name) +
              ")" +
              (n ? "" : ".get()")
            );
          if ("hookRef" === p.type)
            return " HookSet.create('?" + p.name + "') ";
          if ("string" === p.type) return p.text.replace(/\n/g, "\\n");
          if ("colour" === p.type)
            return "Colour.create(" + s(p.colour) + ")";
          if ("datatype" === p.type)
            return "Datatype.create(" + s(p.name) + ")";
          if ("root" === p.type) return a(p.children);
          if ("whitespace" === p.type && n && u)
            return "TwineError.create('operation'," + s(u) + ")";
        }
        var d = void 0,
          h = r(e, "least"),
        ...
        var g = (p || {}).type,
          m = function (e) {
            return {
              isVarRef: !0,
              whitespaceError:
                "I need usable data to be on the " +
                e +
                ' of "' +
                p.text +
                '".',
        ...
        if (g) {
          if ("error" === g)
            return "TwineError.create('syntax'," + s(p.message) + ")";
          if ("comma" === g) (w = ","), (j = !1);
          else if ("spread" === g)
            (w = "Operations.makeSpreader("),
              (b = a(e.slice(d + 1)) + ")"),
              (O = !1);
          else if ("bind" === g)
            (w = "VarBind.create("),
              (b = a(e.slice(d + 1), m("right")) + ")"),
              (O = !1);
          else if ("to" === g)
            (T = "to"),
              (b = a(e.slice(d + 1), m("right"))),
              (v =
                "Operations.setIt(" + a(e.slice(0, d), m("left")) + ")");
          else if ("into" === g)
            (T = "into"),
              (b = a(e.slice(0, d), m("left"))),
              (v =
                "Operations.setIt(" +
                a(e.slice(d + 1), m("right")) +
                ")");
          else if ("where" === g || "when" === g || "via" === g)
            (v =
              "Lambda.create(" +
              (a(e.slice(0, d), {
                isVarRef: !0,
              ...
              (w = s(p.type) + ","),
              (b = s(a(e.slice(d + 1))) + ")");
          else if ("with" === g || "making" === g || "each" === g) {
            var A = e.slice(d + 1);
            ![2, 3].includes(A.length) ||
            "whitespace" !== A[0].type ||
            "tempVariable" !== A[1].type ||
            (A[2] && "whitespace" !== A[2].type)
              ? ((v =
                  "TwineError.create('operation','I need a temporary variable to the right of \\'"),
                (w = p.type),
                (b = "\\'.')"))
              : "each" === g
              ? ((v = "Lambda.create("),
              ...
              : ((v =
                ...
                (w = s(p.type) + ","),
                (b = s(A[1].name) + ")"));
          } else if ("augmentedAssign" === g)
            (T = p.operator),
              (v = a(e.slice(0, d), m("left"))),
              (b =
                "Operations['" +
                T +
                "'](" +
            ...
            var C = function e(t) {
                ...
                if (o)
                  return [
                    ...
                    ? o
                    : ["and", "or"].includes(o.type)
                    ? e(t.slice(0, a)) || e(t.slice(a + 1))
                    : void 0;
              },
              E = C(e.slice(0, d)),
              N = C(e.slice(d + 1)),
              _ =
                "TwineError.create('operation', 'This use of \"is not\" and \"" +
                g +
                "\" is grammatically ambiguous','Maybe try rewriting this as \"__ is not __ " +
                g +
                " __ is not __\"') ";
            if (((x = p.type), l === p.type))
              (x = ""),
                (v = a(e.slice(0, d), {
                  isVarRef: n,
                  elidedComparison: l,
                ...
                (w = ","),
                (b = a(e.slice(d + 1), { elidedComparison: l }).trim());
            else if (E && !N) {
              var I = E,
                P = s(i(I));
              if (
                ...
                return _;
              b =
                "Operations.elidedComparisonOperator(" +
                s(p.type) +
                "," +
                P +
                "," +
                a(e.slice(d + 1), { elidedComparison: g }) +
                ")";
            } else if (!E && N) {
              var M = N,
                D = e.indexOf(M),
              ...
              (b =
                ...
                L +
                "," +
                a(e.slice(0, d), { elidedComparison: g }) +
                ")"),
                (v = a(
                  [].concat(
                    _toConsumableArray(e.slice(D + 1)),
                    [
                      Object.assign(
                        Object.create(M),
                        _defineProperty(
                          {},
                          "inequality" === M.type ? "operator" : "type",
                          o(M)
                        )
                      ),
                    ],
                    _toConsumableArray(e.slice(d + 1, D))
                  )
                ));
            }
          } else if (
            ...
            (k = !0), (x = i(p));
          else if ("addition" === g || "subtraction" === g) {
            var q = a(e.slice(0, d), { testNeedsRight: !0 }).trim();
            if (!q)
              return (
                (p.type = {
                  addition: "positive",
            ...
            x = p.text;
          } else if ("multiplication" === g || "division" === g)
            x = p.text;
          else if ("positive" === g || "negative" === g)
            (x = "*"), (v = "negative" === g ? "-1" : "1");
          else if ("not" === g)
            (w = " "),
              (b = "Operations.not(" + a(e.slice(d + 1)) + ")"),
              (O = !1);
          else if ("belongingProperty" === g)
            (b =
              "VarRef.create(" +
              a(e.slice(d + 1), m("right")) +
              "," +
            ...
            "belongingOperator" === g ||
            "belongingItOperator" === g
          )
            p.type.includes("It")
              ? ((b = "Operations.Identifiers.it"), (j = !1))
              : (b = a(e.slice(d + 1), m("right"))),
              (S = "belonging");
          else if ("property" === g)
            (v =
              "VarRef.create(" +
              a(e.slice(0, d), m("left")) +
              "," +
              s(p.name) +
              ")" +
              (n ? "" : ".get()")),
              (w = " "),
              (O = j = !1);
          else if ("itsProperty" === g || "belongingItProperty" === g)
            (v =
              "VarRef.create(Operations.Identifiers.it," +
              s(p.name) +
              ").get()"),
              (w = " "),
              (O = j = !1);
          else if ("possessiveOperator" === g || "itsOperator" === g)
            p.type.includes("it") &&
              ((v = "Operations.Identifiers.it"), (O = !1)),
              (S = "possessive");
          else if ("twineLink" === g)
            (w =
              'Macros.run("link-goto", [section,' +
              s(p.innerText) +
              "," +
              s(p.passage) +
              "])"),
            ...
            "macroName" !== R.type &&
              ...
              (w =
                "Macros.run(" +
                (R.isMethodCall ? a(R.children) : '"' + p.name + '"') +
                ", [section," +
                a(p.children.slice(1)) +
                "])"),
              (O = j = !1);
          } else
            "grouping" === g &&
              ((w = "(" + a(p.children, { isVarRef: n }) + ")"),
              (O = j = !1));
        } else;
        return d > -1
          ? (x && (n = !1),
            (v = v || a(e.slice(0, d), { isVarRef: n }).trim()),
            (b = b || a(e.slice(d + 1)).trim()),
            k && !v && (v = " Operations.Identifiers.it "),
            (O && !v) || (j && !b)
              ? f && j && !b
                ? ""
                : "TwineError.create('operation','I need some code to be " +
                  (O ? "left " : "") +
                  (O && j ? "and " : "") +
                  (j ? "right " : "") +
                  'of "' +
              ...
              ? v + w + b
              : T
              ? "Operations.makeAssignmentRequest(" + [v, b, s(T)] + ")"
              : S
              ? "VarRef.create(" +
                ("belonging" === S ? b : v) +
                ",{computed:true,value:" +
              ...
              : "")
          : 1 === e.length
          ? (("value" in e[0] ? e[0].value : e[0].text) + "").trim() ||
            " "
          : e.reduce(function (e, t) {
              return e + a(t, { isVarRef: n });
            }, "");
      }
      var s = e.toJSLiteral,
        c = e.impossible;
          ...
          exec: (function () {
            ...
            return function (r) {
              return "string" != typeof r
                ? (s(
                    "Renderer.exec",
                    "source was not a string, but " +
                      (void 0 === r ? "undefined" : _typeof(r))
                  ),
                  "")
                : r === e
                ? n
                : ((e = r), (n = l.render(t.lex(r).children)));
            };
          })(),
          render: function e(s) {
            var p = "",
              d = [];
            if (!s) return p;
            for (var h = s.length, y = 0; y < h; y += 1) {
              var g = s[y];
              switch (g.type) {
                case "error":
                  p += r.create("syntax", g.message).render(a(g.text))[0]
                    .outerHTML;
                  break;
                case "numbered":
                case "bulleted":
                  var m = "numbered" === g.type ? "ol" : "ul";
                  p += "<" + m + ">";
                  for (var v = 1; y < h && s[y] && s[y].type === g.type; )
                    (p += ("<" + m + ">").repeat(
                      Math.max(0, s[y].depth - v)
                    )),
                      (p += ("</" + m + ">").repeat(
                        Math.max(0, v - s[y].depth)
                      )),
                      (v = s[y].depth),
                      (p += o(s[y], "li")),
                      (y += 1);
                ...
                case "align":
                  for (; g && "align" === g.type; ) {
                    ...
                    for (; y < h && s[y] && "align" !== s[y].type; )
                      y += 1;
                    var T = e(s.slice(x, y)),
                      S = "";
                    switch (w) {
                      case "center":
                        S += f + "margin-left: auto; margin-right: auto;";
                        break;
                      case "justify":
                      case "right":
                        S += "text-align: " + w + ";";
                ...
                case "scriptStyleTag":
                case "tag":
                  var C = g.text.toLowerCase();
                  /^<\/?(?:table|thead|tbody|tr|tfoot|td|th)\b/.test(C) &&
                    d[g.text.startsWith("</") ? "shift" : "unshift"](C),
                    (p += g.text.startsWith("</")
                      ? g.text
                      : g.text.replace(/>$/, " data-raw>"));
                  break;
                case "sub":
                case "sup":
                case "strong":
                ...
                case "hook":
                  p +=
                    "<tw-hook " +
                    (g.hidden ? "hidden " : "") +
                    (g.name ? 'name="' + u(g.name) + '"' : "") +
                    (l.options.debug && g.name
                      ? ' title="Hook: ?' + g.name + '"'
                      : "") +
                    ' source="' +
                    a(g.innerText) +
    ...
    define("internaltypes/changedescriptor", [
      "jquery",
      "utils",
      "renderer",
      "datatypes/hookset",
        ...
        u = {
                ...
                Array.isArray(e.styles) &&
                  ...
                  setTimeout(function () {
                    return t.css(
                      Object.assign.apply(
                        Object,
                        _toConsumableArray([{}].concat(e.styles))
                      )
                    );
                  }),
                  e.attr &&
          ...
          render: function () {
            var t = this,
              ...
              v = this.target,
              b = this.append;
            if ((i(this, c), !d || void 0 !== m.popAttr("hidden")))
              return (
                u
                  .create({
                    target: m,
                    data: Object.assign({}, h, { hiddenSource: n }),
                  })
                  .update(),
                e()
              );
            if ((Array.isArray(g) && g.length && (m = g), !m))
              return (
                o(
            ...
            var w = e(),
              x = function (e, n) {
                return function (r) {
                  (n &&
                    1 & r[0].compareDocumentPosition(document) &&
                    2 & r[0].compareDocumentPosition(v[0])) ||
                    (w = w.add(
                      t
                        .create({
                          target: r,
            ...
            if (
              ([].concat(m).forEach(function t(n, i, o) {
                var a =
                    arguments.length > 3 && void 0 !== arguments[3]
                      ? arguments[3]
                      : b,
                ...
                r.isPrototypeOf(n)
                  ? n.forEach(y, x(a, s))
                  : n.jquery && n.length > 1
                  ? Array.from(n).map(e).forEach(x(a))
                  : n.target &&
                    n.append &&
                    t(n.target, i, o, n.append, n.before);
              }),
              w.length || Array.isArray(m) || r.isPrototypeOf(m))
            )
              return w;
            if (!(b in m)) {
              if ("replace" !== b)
                return (
                  o(
                    "Section.render",
                    "The target doesn't have a '" + b + "' method."
                  ),
                  e()
                );
              m.empty(), (b = "append");
            ...
            return (
              (w = e(n && e.parseHTML(s(n), document, !0))),
              m[b](w.length ? w : void 0),
              this.update(),
              l && !p && a("replace" === b ? m : w, l, f),
              w
            );
          },
        };
    ...
    define("datatypes/changercommand", [
      "utils",
      ...
      var i = e.impossible,
        ...
        s = {
          ...
          create: function (e) {
            ...
            return (
              Array.isArray(t) ||
                i("ChangerCommand.create", "params was not an array"),
              Object.assign(Object.create(this), {
                macroName: e,
                params: t,
                next: n,
          ...
          run: function (e) {
            var t = a[this.macroName].apply(
              a,
              [e].concat(_toConsumableArray(this.params))
            );
        ...
        (m = Object.assign(
          {
            ...
            pastPassageNames: function () {
              for (var e = [], t = d - 1; t >= 0; t--)
                e.unshift(p[t].passage);
              return e;
            },
            play: function (e) {
              h || s("State.play", "present is undefined!"),
                (h.passage = e),
                (p = p.slice(0, d + 1).concat(h)),
                (d += 1),
                a(e),
                g.forward.forEach(function (t) {
                  return t(e);
                });
            },
            rewind: function (e) {
              ...
              if (e)
                if ("string" == typeof e) {
                  if ((t = this.passageNameLastVisited(e)) === 1 / 0)
                    return;
            ...
            on: function (e, t) {
              return e in g
                ? ("function" != typeof t ||
                    ...
                    g[e].push(t),
                  m)
                : void s("State.on", "invalid event name");
            },
            reset: function () {
              window.jasmine &&
                ((p = []),
          ...
          (function () {
            function e(t) {
              return (
                ...
                (t instanceof Set && Array.from(t).every(e)) ||
                (t instanceof Map && Array.from(t.values()).every(e)) ||
                n.isPrototypeOf(t)
              );
            }
            function i(e, t) {
            ...
            function o(e, t) {
              if (
                ...
                if (Array.isArray(t["(dataset:)"]))
                  return new Set(t["(dataset:)"]);
                if (Array.isArray(t["(datamap:)"]))
              ...
              if (
                ...
                return r.create(
                  ...
                  "The variable $" +
                    ...
                    " holds " +
                    c(u) +
                    " (which is, or contains, a complex data value) on turn " +
                    l +
            ...
            function u(e) {
              ...
              return (s = (n = n.map(function (e) {
                return "object" ===
                  (void 0 === e ? "undefined" : _typeof(e)) &&
                  e.hasOwnProperty("passage") &&
                  e.hasOwnProperty("variables")
                  ? t.hasValid(e.passage)
                    ? ((e.variables = Object.assign(
                        Object.create(r),
                        e.variables
                      )),
                      (r = e.variables),
                      Object.assign(Object.create(f), e))
                    : Error(
                        "The data refers to a passage named '" +
                          e.passage +
            ...
            return { serialise: s, deserialise: u };
          })()
        )),
        Object.seal(f),
        Object.freeze(m)
    ...
    define("datatypes/colour", ["jquery"], function (e) {
      function t(t) {
        ...
        return (
          (n = n.startsWith("rgb")
            ? n.match(/\d+/g).reduce(function (e, t, n) {
                return (e["rgb"[n]] = +t), e;
              }, {})
            : { r: 192, g: 192, b: 192 }),
          (s[t] = n),
      ...
      function r(e) {
        ...
        return (
          (u = Math.round(60 * u)),
          { h: u, s: s > 0.5 ? c / (2 - o - a) : c / (o + a), l: s, a: i }
        );
      }
      function i(e) {
        function t(e) {
        ...
        c = Object.freeze({
          ...
          "TwineScript_+": function (e) {
            var t = this,
              n = e;
            return c.create({
              r: Math.min(Math.round(0.6 * (t.r + n.r)), 255),
              g: Math.min(Math.round(0.6 * (t.g + n.g)), 255),
              b: Math.min(Math.round(0.6 * (t.b + n.b)), 255),
              a: (t.a + n.a) / 2,
            });
          },
          TwineScript_Print: function () {
          ...
          create: function (e) {
            return "string" == typeof e
              ...
              ? (("a" in e && "number" == typeof e.a) || (e.a = 1),
                Object.assign(Object.create(this), e))
              : this.create(i(e));
          },
          isHexString: function (e) {
            return (
              "string" == typeof e &&
              "#" === e[0] &&
              (e.slice(1).match(o) || e.slice(1).match(a))
            );
          },
          isCSS3Function: function (e) {
            return (
              "string" == typeof e &&
              /^(?:rgb|hsl)a?\(\s*\d+\s*,\s*\d+%?\s*,\s*\d+%?(?:,\s*\d+(?:\.\d+)?\s*)?\)$/.test(
                e
              )
            );
          },
    ...
    define("internaltypes/varref", [
        ...
        if (w(e)) {
          ...
          if ("number" == typeof n) {
            if (0 === n)
              return t.create(
                "property",
                "You can't access elements at position 0 of " +
                  x(e) +
                  ".",
            ...
            "string" == typeof n &&
            (o = /(\d+)(?:st|[nr]d|th)last/i.exec(n))
          )
            n = -o[1];
          else if (
            "string" == typeof n &&
            (o = /(\d+)(?:st|[nr]d|th)/i.exec(n))
          )
            n = o[1] - 1;
          else if ("last" === n) n = -1;
          else if (
            !["length", "any", "all"].includes(n) ||
            i.isPrototypeOf(e)
          )
            return t.create(
              "property",
          ...
          if (!["length", "any", "all"].includes(n))
            return t.create(
              "property",
              "You can only get the 'length', 'any' and 'all' of a " +
                x(e) +
                ".",
          ...
          return t.create(
            "property",
            "You can't get data values from " + x(e) + "."
          );
        return n;
      }
      function s(e, n) {
        return {
          compiledPropertyChain: n.reduce(function (r, i, o) {
            i.computed && (i = i.value),
              k.isPrototypeOf(i) && (i = i.get()),
              (i = Array.isArray(i)
                ? i.map(function (t) {
                    return a(e, t);
                  })
                : a(e, i));
            var s = void 0;
            return (s = t.containsError(r, i))
              ? s
              : (o < n.length - 1 && (e = g(e, i)), r.push(i), r);
          }, []),
          deepestObject: e,
        };
      }
      function c(e, t) {
        return t - 0 < 0 && Math.abs(t) <= e.length
          ? e.length + (t - 0)
          : t;
      }
      function u(e, t) {
        var n = { any: "'any' value of ", all: "'all' values of " }[t];
        return {
          determiner: t,
      ...
      function l(e, t) {
        ...
        if ((w(e) && (t = c(e, t)), "any" === t || "all" === t))
          return u(e, t);
        if (e.TwineScript_GetElement && Number.isFinite(+t))
          return e.TwineScript_GetElement(t);
        var n = e[t];
      ...
      function p(e, n) {
        ...
        if (o.isPrototypeOf(e))
          return t.create(
            "operation",
            "I can't modify the components of " + x(e) + "."
          );
        if (e instanceof Map)
          return (
            "string" == typeof n ||
            t.create(
              "operation",
              x(e) + " can only have string data names, not " + x(n) + "."
            )
          );
        if (w(e)) {
          if (["length", "any", "all"].includes(n))
            return t.create(
              "operation",
              "I can't forcibly alter the '" + n + "' of " + x(e) + "."
            );
          if (+n != (0 | n))
            return t.create(
              "property",
        ...
        return e.TwineScript_Identifiers && n in e
          ? t.create(
              "keyword",
              "I can't alter the value of the '" + n + "' identifier.",
              "You can only alter data in variables and hooks, not fixed identifiers."
            )
          : ("number" != typeof e && "boolean" != typeof e) ||
              t.create(
                "operation",
                "You can't alter the data values of " + x(e) + "."
              );
      }
      function d(e, t, n) {
        var r = t;
        e instanceof Map
          ? e.set(t, n)
          : (w(e) && (t = c(e, t)),
            e.TwineScript_Set ? e.TwineScript_Set(t) : (e[t] = n)),
      ...
      function h(e, t) {
        var n = t;
        w(e) && (t = c(e, t)),
          Array.isArray(e) && O.exec(t)
            ? e.splice(t, 1)
            : e instanceof Map || e instanceof Set
            ? e.delete(t)
            : delete e[t],
          C.delete.forEach(function (t) {
            return t(e, n);
          });
      }
      function y(e) {
        ...
        return { get: t, set: t, delete: t, varref: !0 };
      }
      function g(n, r, o) {
        if (Array.isArray(r))
          return i.isPrototypeOf(n)
            ? n.TwineScript_GetElement(r)
            : r
                .map(function (e) {
                  return g(n, e, e);
                })
        ...
        return void 0 === a
          ? n === e.variables
            ...
            ? t.create(
                "property",
                "There isn't a temp variable named _" +
                  o +
                  " in this place.",
            ...
            : t.create(
                "property",
                "I can't find a " + f(o) + " data name in " + x(n)
              )
          : a;
      }
      function m(e, n) {
        var r = this,
          i = this.compiledPropertyChain
            .reduce(function (e, t) {
              var n = void 0;
              return (
                (n =
      ...
      return (k = Object.freeze({
          ...
          return !this.object ||
            ...
            ? m.call(
                ...
                function (e, n, r) {
                  ...
                  if (
                    (s =
                      t.containsError(e, o, a) ||
                      t.containsError(p(o, a)))
                  )
                    return s;
                  if (e && e.TwineScript_Unstorable)
                    return t.create(
                      "operation",
                      T(e) + " can't be stored."
                    );
                  if ((r > 0 && (o = S(o)), "string" == typeof o)) {
                    if (
                      "string" != typeof e ||
                      e.length !== (Array.isArray(a) ? a.length : 1)
                    )
                      return t.create(
                        "datatype",
                        "I can't put this non-string value, " +
                          x(e) +
                          ", in a string."
                      );
                    ...
                    [].concat(a).forEach(function (e) {
                      0 + e < 0 && (e = o.length + (0 + e)),
                        (o = [].concat(
                          _toConsumableArray(o.slice(0, e)),
                          [c.shift()],
                          _toConsumableArray(o.slice(e + 1))
                        ));
                    }),
                      (o = o.join(""));
                  } else
          ...
          return m.call(
            ...
            function (e, n, r) {
              var i = _slicedToArray(n, 2),
                ...
                s = void 0;
              if (
                (s = t.containsError(e, o, a) || t.containsError(p(o, a)))
              )
                return s;
              if ((r > 0 && (o = S(o)), null === e)) {
                var u = "string" == typeof o;
                u && (o = [].concat(_toConsumableArray(o))),
                  Array.isArray(a)
                    ? (w(o) &&
                        ((a = [].concat(_toConsumableArray(new Set(a)))),
                        a.sort(function (e, t) {
                          return c(o, t) - c(o, e);
                        })),
        ...
        create: function (e, n) {
          ...
          var i = s(e, n),
            ...
            a = i.deepestObject;
          return (r = t.containsError(o, a))
            ? y(r)
            : Object.assign(Object.create(k), {
                object: e,
                propertyChain: n,
        ...
        get TwineScript_ObjectName() {
          var t = this,
            n = function (n, r) {
              return r ||
                (t.object !== e.variables &&
                  !t.object.TwineScript_VariableStore)
                ? f(n)
                : n;
            };
          return (
            (this.object === e.variables
              ? "$"
              : this.object.TwineScript_VariableStore
              ? "_"
              : x(this.object) + "'s ") +
            (1 === this.propertyChain.length
              ...
              : this.propertyChain.reduce(function (e, t, r) {
                  return e + "'s " + n(t, r);
                })) +
            (this.object.TwineScript_VariableStoreName
        ...
        on: function (e, t) {
          return e in C
            ? ("function" != typeof t || C[e].includes(t) || C[e].push(t),
              k)
            : void v("VarRef.on", "invalid event name");
        },
      }));
    }),
      ...
      return function (e) {
        return function t(n, r) {
          var i,
            ...
            a,
            s,
            c = /(^-?[0-9]+(\.?[0-9]*)[df]?e?[0-9]?$|^0x[0-9a-f]+$|[0-9]+)/gi,
            u = /(^[ ]*|[ ]*$)/g,
            ...
            v =
              parseInt(h.match(f)) ||
              (1 !== g.length && h.match(l) && Date.parse(h)),
            b =
              parseInt(y.match(f)) ||
              (v && y.match(l) && Date.parse(y)) ||
              null;
          if (
            (e &&
              window.Intl &&
              window.Intl.Collator &&
              (a = window.Intl.Collator(e)),
            b)
          ) {
            if (v < b) return -1;
            if (v > b) return 1;
          }
          for (var w = 0, x = Math.max(g.length, m.length); w < x; w++) {
            if (
              ((i =
                (!(g[w] || "").match(p) && parseFloat(g[w])) ||
                g[w] ||
                0),
              (o =
                (!(m[w] || "").match(p) && parseFloat(m[w])) ||
                m[w] ||
                0),
              isNaN(i) !== isNaN(o))
            )
          ...
          Object.freeze({
            ...
            create: function (e, t, i) {
              ...
              if (a.isPrototypeOf(e)) {
                ...
                if (
                  ...
                  (!e ||
                    !e.varref ||
                    !n.isPrototypeOf(e.object) ||
                    e.propertyChain.length > 1)
                )
                  return r.create(
                    "syntax",
                    "This lambda needs to start with a single temporary variable."
                  );
                (s = Object.create(this)),
                  (s.loop = e ? e.propertyChain[0] : "");
              }
              s[t] = i;
              var c = [s.making, s.with, s.loop].filter(function (
                e,
                t,
                n
              ) {
              ...
              return c.length
                ? r.create(
                    "syntax",
                    "This lambda has two variables named '" + c[0] + "'.",
            ...
            apply: function (e, t) {
              ...
              (f = f || Object.create(e.stack[0] || n)),
                ...
                e.stack.unshift(
                  Object.assign(Object.create(null), { tempVariables: f })
                ),
                !o || this.with || this.making || this.when
                  ? e
                      .eval("Operations")
                      .initialiseIt(
                        r.create(
                  ...
                  : e.eval("Operations").initialiseIt(o);
              var p = !l && this.via,
                d = e.eval(
    ...
    define("macros", [
            ...
            if (n && !0 === n.spreader) {
              ...
              if (Array.isArray(r) || "string" == typeof r)
                ...
                r instanceof Set
                  ? e.push.apply(
                      e,
                      _toConsumableArray(Array.from(r).sort(t("en")))
                    )
                  : e.push(
                      c.create(
                        "operation",
      ...
      function l(e, t, n) {
        (n = [].concat(n || [])),
          (e =
            "(" + (Array.isArray(e) && e.length > 1 ? e[0] : e) + ":)");
        var r = void 0;
        return (
          (r =
            n.length > 0
              ? "The " +
                e +
                " macro must only be given " +
                n.map(v).reduce(function (e, t, n, r) {
                  return (
                    e +
                    (0 === n ? "" : n < r.length - 1 ? ", " : ", and ") +
                    t
                  );
                }, "") +
                (n.length > 1 ? ", in that order" : ".")
              : "The macro must not be given any data - just write " +
                e +
                "."),
          function (i) {
            for (
              ...
              s[u - 1] = arguments[u];
            for (
              var l = void 0, f = 0, p = Math.max(s.length, n.length);
              f < p;
              f += 1
            ) {
              var g = (function (t, i) {
                ...
                return t >= n.length && !l
                  ? {
                      v: c.create(
                        ...
                        s.length -
                          n.length +
                          " too many values were given to this " +
                          e +
                          " macro.",
                        r
                      ),
                  ...
                  : (a || (a = l),
                    !a.innerType ||
                      ("rest" !== a.pattern &&
                        "zero or more" !== a.pattern) ||
                      ((l = a.innerType),
                      "rest" === a.pattern && (a = a.innerType)),
                    b(u, a)
                      ? void 0
                      : void 0 === u
                      ? {
                          v: c.create(
                            ...
                            "The " +
                              e +
                              " macro needs " +
                              h(n.length - t, "more value") +
                              ".",
                            r
                          ),
                        }
                      : u &&
                        u.TwineScript_Unstorable &&
                        (a === w.TypeSignature.Any ||
                          (a.innerType &&
                            a.innerType === w.TypeSignature.Any))
                      ? {
                          v: c.create(
                            "datatype",
                            e +
              ...
              if ("object" === (void 0 === g ? "undefined" : _typeof(g)))
                return g.v;
            }
        ...
        T = function (e, t, n, r) {
          return function () {
            for (
              ...
              o[a] = arguments[a];
            var c = t.apply(void 0, _toConsumableArray(o.slice(1)));
            if (c) return c;
            var u = void 0;
            r && (u = s.create());
            var l = Object.assign(
              ...
              r
                ? {
                    ...
                    TwineScript_Run: function () {
                      return n.apply(void 0, [u].concat(o));
                    },
                  }
                : {
                    TwineScript_Run: function () {
      ...
      return (
        (w = {
          ...
          addChanger: function e(t, n, r, o) {
            return (
              f(t, u(l(t, n, o))),
              i.register(Array.isArray(t) ? t[0] : t, r),
              e
            );
          },
    ...
    define("datatypes/datatype", [
      ...
      var n = Object.freeze({
        ...
        TwineScript_is: function (e) {
          return n.isPrototypeOf(e) && e.name === this.name;
        },
        TwineScript_Clone: function () {
          return n.create(this.name);
        },
        ...
        create: function (e) {
          var t =
            arguments.length > 1 && void 0 !== arguments[1]
              ? arguments[1]
              : "one way";
          return n.isPrototypeOf(e) || e.varref
            ? Object.assign(Object.create(this), { varRef: e, bind: t })
            : r.create(
                "operation",
                "I can only 'bind' a variable, not " + i(e) + "."
              );
        },
      });
    }),
    ...
    define("twinescript/operations", [
      ...
      function i(e, t, n, i) {
        return (
          ...
          function (o, a) {
            1 === t.length && (a = o);
            var s = void 0;
            return (s = r.containsError(o, a))
              ? s
              : (void 0 === o ? "undefined" : _typeof(o)) !== e ||
                (void 0 === a ? "undefined" : _typeof(a)) !== e
              ? r.create(
                  "operation",
                  "I can only " +
                    n +
      ...
      function o(e) {
        return function (t, n) {
          var i = void 0;
          return (i = r.containsError(t, n))
            ? i
            : t && t.varref
            ? r.create(
                "operation",
                "I can't give an expression a new value."
              )
            : (void 0 === t ? "undefined" : _typeof(t)) !==
              ...
              (s(t) &&
                ...
                s(n) &&
                "TwineScript_TypeName" in n &&
                t.TwineScript_TypeName !== n.TwineScript_TypeName) ||
              c(t) !== c(n)
            ? r.create(
                "operation",
                y(t) + " isn't the same type of data as " + y(n)
              )
            : e(t, n);
        };
      }
      function a(e) {
        return function t(n, i) {
          var o = void 0;
          if ((o = r.containsError(n, i))) return o;
          if (((m = n), n.determiner)) {
            var a = "all" === n.determiner;
            return n.array.reduce(function (e, n) {
              var o = void 0,
                s = t(n, i);
              return (o = r.containsError(e, s))
                ? o
                : a
                ? e && s
                : e || s;
          ...
          if (i.determiner) {
            var s = "all" === i.determiner;
            return i.array.reduce(function (e, i) {
              var o = void 0,
                a = t(n, i);
              return (o = r.containsError(e, a))
                ? o
                : s
                ? e && a
                : e || a;
        ...
        (g = {
          ...
          elidedComparisonOperator: function (e, t) {
            ...
            return r.reduce(function (n, r) {
              return "boolean" == typeof r ? r : g[e](n, g[t](m, r));
            }, "and" === e);
          },
          and: i(
            "boolean",
          ...
          "+": o(function (e, t) {
            ...
            return e instanceof Map
              ...
              ? e + t
              : r.create("operation", "I can't use + on " + y(e) + ".");
          }),
          "-": o(function (e, t) {
            if (Array.isArray(e))
            ...
            if (e instanceof Set) {
              ...
              return new Set(
                [].concat(_toConsumableArray(e)).filter(function (e) {
          ...
          isA: a(l),
          isNotA: a(function (e, t) {
            return !l(e, t);
          }),
          typifies: a(function (e, t) {
            return l(t, e);
          }),
          untypifies: a(function (e, t) {
            return !l(t, e);
          }),
          matches: a(h),
          where: function (e, t, n) {
            var i = void 0;
            return (i = r.containsError(e))
              ? i
              : "boolean" != typeof e
              ? r.create(
                  "operation",
          ...
          makeSpreader: function (e) {
            return { value: e, spreader: !0 };
          },
          makeAssignmentRequest: function (e, n, i) {
            var o = r.containsError(e, n);
            return (
              o ||
              (s(e) && "varref" in e
                ? t.create(e, n, i)
                : r.create(
                    "operation",
                    "I can't store a new value inside " + y(e) + "."
                  ))
            );
          },
          setIt: function (e) {
            return r.containsError(e)
              ...
              : r.create(
                  "operation",
                  "I can't put a new value into " + y(e) + "."
                );
          },
    ...
    define("twinescript/environ", [
      ...
      return function (section) {
        ("object" ===
          (void 0 === section ? "undefined" : _typeof(section)) &&
          section) ||
          Utils.impossible(
            "TwineScript.environ",
            "no Section argument was given!"
          );
    ...
    define("internaltypes/twinenotifier", ["jquery", "utils"], function (
      e,
      t
    ) {
      var n = t.impossible,
    ...
    define("section", [
    ...
    ], function (e, t, n, r, i, o, a, s, c, u, l, f, p, d, h) {
      function y(e, n, r) {
        if (
          n &&
          ...
          if (!this.renderInto(r.popAttr("source"), r, n)) {
            ...
            if (
              (["if", "elseif", "unless", "else"].includes(i) &&
                (e.addClass("false"),
                "elseif" !== i && (this.stack[0].lastHookShown = !1)),
              r.data("live"))
            ) {
              var o = r.data("live"),
                a = o.delay,
          ...
          if (!1 === n)
            return (
              r.attr("source") &&
                r.data("hiddenSource", r.popAttr("source")),
              e.addClass("false"),
              void (this.stack[0].lastHookShown = !1)
            );
          !0 !== n &&
            e.replaceWith(
              d
                .create(
                  "datatype",
                  S(n) + " cannot be attached to this hook.",
      ...
      function g(t) {
        ...
        if (
          r &&
          ((r instanceof Text && !r.textContent.trim()) ||
            "br" === (r.tagName || "").toLowerCase())
        ) {
          var i = g(r),
            o = i.whitespace,
            a = i.nextElem;
          return { whitespace: e(r).add(o), nextElem: a };
        }
        return { whitespace: e(), nextElem: e(r) };
      }
      function m(r) {
        ...
        for (s = r; c.isPrototypeOf(i); ) {
          ...
          if (
            ((a = p.whitespace),
            (s = p.nextElem),
            s[0] instanceof Text && "+" === s[0].textContent.trim())
          ) {
            var m = void 0,
              v = s,
              b = g(v);
            if (
              ((m = b.whitespace), (s = b.nextElem), s.is(n.expression))
            ) {
              ...
              var x = o["+"](i, w);
              e(a).add(v).add(m).remove(),
                (i = d.containsError(x)
                  ? d.create(
                      "operation",
                      "I can't combine " + S(i) + " with " + S(w) + ".",
                      "function" == typeof w.TwineScript_Run
                        ? "If you want to attach this changer to " +
                            S(w) +
          ...
          if (s.is(n.expression)) {
            var O = this.eval(s.popAttr("js"));
            if (d.containsError(O)) {
              i = O;
              break;
            }
            if (
              ...
              "function" == typeof O.TwineScript_Attach
            ) {
              i = O.TwineScript_Attach(i);
              break;
            }
            return c.isPrototypeOf(O)
              ? void r.replaceWith(
                  d
                    .create(
                      "operation",
          ...
          var j = r.attr("title") || "(" + i.macroName + ": ...)";
          return void r.replaceWith(
            d
              .create(
                "syntax",
                "The (" +
                ...
                "Macros like this should appear to the left of a hook: " +
                  j +
                  "[Some text]"
              )
              .render(r.attr("title"))
        ...
        u = u.length ? u : g(r).nextElem.filter(n.hook);
        var k = void 0;
        if ((k = d.containsError(i)))
          k instanceof Error && (k = d.fromError(k)),
            r.replaceWith(k.render(r.attr("title"), r));
        else if (h.isPrototypeOf(i)) r.append(i.render());
        else if (i && "function" == typeof i.TwineScript_Run)
          if (((i = i.TwineScript_Run()), d.containsError(i)))
            r.replaceWith(i.render(r.attr("title")));
          else if (f.isPrototypeOf(i)) {
            if (i.data && i.data.live)
              return void r.replaceWith(
                d
                  .create(
                    "unimplemented",
          ...
          (!u.length &&
            ("string" == typeof i ||
              ...
              l.isPrototypeOf(i))) ||
          (i &&
            "function" == typeof i.TwineScript_Print &&
            !c.isPrototypeOf(i))
            ? ((i = T(i)),
              "string" != typeof i &&
                t.impossible(
                  "printBuiltinValue() produced a non-string " +
                    (void 0 === i ? "undefined" : _typeof(i))
                ),
              d.containsError(i)
                ? (i instanceof Error && (i = d.fromError(i)),
                  r.replaceWith(i.render(r.attr("title"))))
                : this.renderInto(i, r))
            : u.length
            ? y.call(this, r, i, u)
            : c.isPrototypeOf(i) ||
              ...
              t.impossible(
                "Section.runExpression",
                "The expression evaluated to an unknown value: " +
                  i.toSource()
              );
      }
      function v(e) {
      ...
      function w(t) {
        function n(t) {
          return (
            0 ===
            e(this || t)
              .parentsUntil("tw-collapsed")
              .filter("tw-verbatim, tw-expression, [collapsing=false]")
              .length
          );
        }
        var r = v(t);
        ...
        var i = b(t);
        e(i).parents("tw-collapsed").length || (i = null),
          t
            .findAndFilter("br:not([data-raw])")
            .filter(n)
        ...
        o.reduce(function (e, t) {
          ...
          a > 0 && i && (o[o.length - 1].textContent += " "),
          t[0] && j() && t[0].normalize();
      }
      function x(e, r) {
        var i = this,
        ...
        var s = r.data("hiddenSource") || "",
          ...
          l = function t() {
            if (i.inDOM()) {
              var c = a && a.filter(i, [!0], u);
              if (d.containsError(c))
                return void c.render(e.attr("title")).replaceAll(e);
              if (a && !c[0]) return void setTimeout(t, o);
              i.renderInto(s, r, { append: "replace" }),
                c ||
                  r.find(n.expression + "[name='stop']").length ||
                  (i.inDOM() && setTimeout(t, o));
            }
          };
        setTimeout(l, o);
      }
      ...
      return (
        (O = {
          create: function (n) {
            (n instanceof e && 1 === n.length) ||
              t.impossible(
                "Section.create",
                "called with no DOM element"
              );
          ...
          renderInto: function (t, r, i) {
            var o = this,
              a =
                arguments.length > 3 && void 0 !== arguments[3]
                  ? arguments[3]
                  : null,
              s = f.create({ target: r, source: t, section: this });
            if (i)
              if (c.isPrototypeOf(i)) {
                var u = i.run(s);
                if (d.containsError(u))
                  return u.render(r.attr("title")).replaceAll(r), !1;
              } else Object.assign(s, i);
            if (((r = s.target), this.stack.length >= 50))
              return (
                d
                  .create(
                    "infinite",
            ...
            var l = function (t, i) {
              ...
              var s = o;
              a
                .findAndFilter(n.hook + "," + n.expression)
                .each(function () {
                  var t = e(this);
                  switch (t.tag()) {
                    case n.hook:
                      if (
                        (t.attr("hidden") &&
                          (t.removeAttr("hidden"),
                          t.data("hiddenSource", t.popAttr("source"))),
                        t.attr("source") &&
                          s.renderInto(t.popAttr("source"), t),
                        t.find("[earlyexit]").length)
                      )
                        return !1;
                      break;
                    case n.expression:
                      if (t.attr("js")) {
                        if ("earlyexit" === m.call(s, t))
                          return a.attr("earlyexit", !0), !1;
                        return;
                      }
                  }
                }),
                a.length &&
                  r instanceof e &&
                  r.is(n.hook) &&
                  r.parents("tw-collapsed").length > 0 &&
                  w(a),
                a.findAndFilter(n.collapsed).each(function () {
                  w(e(this));
                }),
                o.stack.shift();
            };
            if (!a) {
              a = Object.create(
                this.stack.length ? this.stack[0].tempVariables : p
              );
              var h = r && r.tag();
              a.TwineScript_VariableStoreName =
                h === n.hook
                  ? r.attr("name")
                    ? "?" + r.attr("name")
                    : "an unnamed hook"
                  : h === n.expression
                  ? "a " + r.attr("type") + " expression"
                  : h === n.passage
                  ? "this passage"
                  : "an unknown scope";
            }
            return (
              Object.keys(s.loopVars).length
                ? (function () {
                    for (
                      ...
                      l(s, {
                        tempVariables: Object.keys(e).reduce(function (
                          t,
                          n
                        ) {
                ...
                : l(s, { tempVariables: a }),
              0 === this.stack.length && this.updateEnchantments(),
              s.enabled
            );
          },
    ...
    define("engine", [
      ...
      function a() {
        ...
        h.permalink &&
          r.save &&
          i.append(
            '<tw-icon tabindex=0 class="permalink" title="Permanent link to this passage"><a href="#' +
              r.save() +
              '">&sect;'
          );
        var o = e(
        ...
        return (
          r.pastLength <= 0 && o.css("visibility", "hidden"),
          r.futureLength <= 0 && a.css("visibility", "hidden"),
          i.append(o).append(a),
          t
        );
      }
      ...
      function c(c) {
        ...
        if (
          ...
          var x = g.data("enchantedProperties");
          x &&
            y.css(
        ...
        o.hasValid(c) ||
          l(
            "Engine.showPassage",
            "There's no passage with the name \"" + c + '"!'
          ),
          y.detach();
        var T = t.$(y.children(f));
        !m && v && (p(T, v, w), T.css("position", "absolute"));
        var S = (d.get("tags") || []).join(" "),
          O = a().appendTo(y).attr({ tags: S });
        y.attr({ tags: S });
        var j = i.create(O),
          k = d.get("source");
        (k =
          o.getTagged("header").map(s.bind(0, "header")).join("") +
          (h.debug
            ? o
                .getTagged("debug-header")
                .map(s.bind(0, "debug-header"))
                .join("")
            : "") +
          k +
          o.getTagged("footer").map(s.bind(0, "footer")).join("") +
          (h.debug
            ? o
                .getTagged("debug-footer")
                .map(s.bind(0, "debug-footer"))
                .join("")
            : "")),
          r.pastLength <= 0 &&
            (h.debug &&
              (k =
                o
                  .getTagged("debug-startup")
                  .map(s.bind(0, "debug-startup"))
                  .join("") + k),
            (k =
              o.getTagged("startup").map(s.bind(0, "startup")).join("") +
              k)),
          j.renderInto(k, O, { transition: b, transitionTime: w }),
          g.append(y.parents().length ? y.parents().last() : y),
          scroll(
            0,
            m
              ? O.offset().top - 0.05 * e(window).height()
              : y.offset().top
          );
      }
      var u = t.escape,
    ...
    define("debugmode", [
      ...
      return function () {
        function t(t, n, r) {
          var i = l.children('[data-name="' + t + '"]'),
            o = a(n);
          i.length ||
            (i = e(
              '<div class="variable-row" data-name="' +
                t +
                '" data-value="' +
                o +
                '"></div>'
            ...
            i
              ...
              .append(
                "<span class='variable-name " +
                  ...
                  t +
                  (r
                    ? "<span class='temporary-variable-scope'>" +
                      r +
                      "</span>"
                    : "") +
                  "</span><span class='variable-value'>" +
                  a(n) +
                  "</span>"
              );
          var s = l.children();
          u.text(s.length + " Variable" + (1 !== s.length ? "s" : ""));
        }
        function i() {
          var r = [];
          l.children().each(function (i, o) {
            ...
            var s = o.attr("data-name"),
              c = o.attr("data-value");
            s.startsWith("TwineScript") ||
              (s in n.variables
                ? (r.push(s),
                  a(n.variables[s]) !== c && t(s, n.variables[s]))
                : o.remove());
          });
          for (var i in n.variables)
            i.startsWith("TwineScript") ||
              r.includes(i) ||
              t(i, n.variables[i]);
        }
        var s = e(
            "<tw-debugger><div class='variables'></div>Turns: <select disabled></select><button class='show-invisibles'>Debug View</button><button class='show-variables enabled'>0 Variables</button></tw-debugger>"
          ),
          c = s.find(".show-invisibles");
        c.click(function () {
          e(document.documentElement).toggleClass("debug-mode"),
            c.toggleClass("enabled");
        });
        var u = s.find(".show-variables"),
          l = s.find(".variables");
        u.click(function () {
          l[u.is(".enabled") ? "attr" : "removeAttr"]("hidden", ""),
        ...
        f.change(function (e) {
          var t = e.target.value,
            r = t - n.pastLength;
          0 !== r &&
            (n[r < 0 ? "rewind" : "fastForward"](Math.abs(r)),
            o.showPassage(n.passage));
        }),
          n
            .on("forward", function (t) {
              var r =
                  arguments.length > 1 &&
                  void 0 !== arguments[1] &&
                  arguments[1],
                i = n.pastLength;
              i > 1 && f.removeAttr("disabled"),
                r ||
                  (f.children().each(function (t, n) {
                    t >= i && e(n).remove();
                  }),
                  f
                    .append(
            ...
            .on("back", function () {
              n.pastLength <= 1 && f.attr("disabled"),
                f.find("[selected]").removeAttr("selected"),
                f.val(n.pastLength);
            })
            .on("load", function (e) {
              f.empty(),
                f[e.length <= 1 ? "attr" : "removeAttr"]("disabled"),
          ...
          n.on("forward", i).on("back", i),
          r
            .on("set", function (e, r, i) {
              (e === n.variables || e.TwineScript_VariableStore) &&
                t(
                  r,
                  i,
                  e === n.variables ? "" : e.TwineScript_VariableStoreName
                );
            })
            .on("delete", function (e, t) {
              e === n.variables &&
                l
                  .find('[data-name="' + t + '"]:not(.temporary)')
                  .remove();
            }),
          e(document.body).append(s);
      };
    }),
    define("macrolib/values", [
      "macros",
      "utils",
      "utils/operationutils",
      "datatypes/colour",
      ...
      e.add(
        ...
        [p(e.TypeSignature.either(String, Number, Boolean, Array))]
      )(
        "substring",
        function (e, t, n, r) {
          return c(t, n, r);
        ...
        function (e, t) {
          return t.replace(new RegExp(s + "+"), function (e) {
            return (
              (e = Array.from(e)),
              e[0].toLowerCase() + e.slice(1).join("").toLowerCase()
            );
          });
        },
        [String]
        ...
        function (e, t) {
          return t.replace(new RegExp(s + "+"), function (e) {
            return (
              (e = Array.from(e)),
              e[0].toUpperCase() + e.slice(1).join("").toLowerCase()
            );
          });
        },
        [String]
        ...
        function (e, t, n) {
          return t <= 0
            ? i.create(
                "macrocall",
                "I can't repeat this string " + t + " times."
              )
            : 0 === n.length
            ? i.create("macrocall", "I can't repeat an empty string.")
            : n.repeat(t);
        },
        [parseInt, String]
      )(
        ...
        function (e, t) {
          return Number.isNaN(+t)
            ? i.create(
                "macrocall",
                "I couldn't convert " + u(t) + " to a number."
              )
            : +t;
        },
        [String]
        ...
        function (e) {
          for (
            ...
            if (
              ...
              return i.create(
                "macrocall",
                "RGB values must be whole numbers between 0 and 255, not " +
                  u(t) +
                  "."
              );
          return r.create({
        ...
        function (e) {
          ...
          return (arguments.length <= 4 ? void 0 : arguments[4]) < 0 ||
            (arguments.length <= 4 ? void 0 : arguments[4]) > 1
            ? i.create(
                "macrocall",
                "Alpha values must be numbers between 0 and 1 inclusive, not " +
        ...
        function (e, t, n, o) {
          var a =
            " values must be numbers between 0 and 1 inclusive, not ";
          return n < 0 || n > 1
            ? i.create("macrocall", "Saturation" + a + u(n) + ".")
            : o < 0 || o > 1
            ? i.create("macrocall", "Lightness" + a + u(o) + ".")
            : ((t = Math.round(t) % 360),
              t < 0 && (t += 360),
              r.create({ h: t, s: n, l: o }));
        },
        ...
        function (e, t, n, o, a) {
          var s =
            " values must be numbers between 0 and 1 inclusive, not ";
          return n < 0 || n > 1
            ? i.create("macrocall", "Saturation" + s + u(n) + ".")
            : o < 0 || o > 1
            ? i.create("macrocall", "Lightness" + s + u(o) + ".")
            : a < 0 || a > 1
            ? i.create("macrocall", "Alpha" + s + u(o) + ".")
            : ((t = Math.round(t) % 360),
              t < 0 && (t += 360),
              r.create({ h: t, s: n, l: o, a: a }));
        },
      ...
      ),
        {
          ...
          either: [
            function () {
              var e;
              return (
                (e = ~~(Math.random() * arguments.length)),
    ...
    define("macrolib/commands", [
      ...
      function p(e) {
        return "(" + e + " " + s.options.ifid + ") ";
      }
      var d = f.printBuiltinValue,
        h = n.TypeSignature,
        y = h.Any,
        g = h.rest,
        m = h.either,
      ...
      n.addCommand(
        ...
        function (e, t, n) {
          return b(e, { source: r.unescape(a.get(n).get("source")) });
        },
        [String]
      )(
        "print",
        ...
        function () {},
        function (e) {
          return o.pastLength < 1
            ? c.create("macrocall", "I can't (undo:) on the first turn.")
            : (t(function () {
                return s.goBack({
                  transitionOut: e.data.t8nDepart,
                  transitionIn: e.data.t8nArrive,
        ...
        function () {
          if ("" === (arguments.length <= 0 ? void 0 : arguments[0]))
            return c.create(
              "macrocall",
              "The first string in a (cycling-link:) can't be empty."
            );
          if (
            arguments.length <=
            (l.isPrototypeOf(
        ...
        function (e, t) {
          ...
          e.data.clickEvent = function (t) {
            ...
            if (o) {
              var i = o.set(r[a]);
              if (c.containsError(i))
                return void t.replaceWith(i.render(r[a]));
            }
            var s = b({}, e, { source: n, transitionDeferred: !1 });
            e.section.renderInto("", null, s, u);
          };
          var f = "<tw-link>" + r[0] + "</tw-link>";
          if (o) {
            var p = o.set(r[a]);
            if (c.containsError(p)) return p;
          }
          return b(e, {
            source: f,
            append: "replace",
        ...
        n.addCommand(
          ...
          function (e, t, n) {
            ...
            e.data.dropdownEvent = function (e) {
              var t = e.val(),
                r = n.set(t);
              if (c.containsError(r))
                return void e.replaceWith(r.render(t));
            };
            var u = n.set(i[0]);
            return c.containsError(u)
              ? u
              : b(e, { source: s, append: "replace" });
          },
          [l, String, g(String)]
        )(
          "show",
          ...
          function () {},
          function (e, n) {
            var r = localStorage.getItem(p("Saved Game") + n);
            if (!r)
              return c.create(
                "saving",
                "I can't find a save slot named '" + n + "'!"
              );
            var i = o.deserialise(r);
              ...
              return void (
                "delete" ===
                  (
                    ...
                    .trim()
                    .toLowerCase() &&
                localStorage.removeItem(p("Saved Game") + n)
              );
            t(s.showPassage.bind(s, o.passage, !1));
          },
          [String],
          !1
        )(
          "alert",
          function () {
            if ("function" != typeof window.alert)
              return c.create(
                "unimplemented",
                "The (alert:) macro doesn't seem to work in this browser. Sorry."
              );
          },
          function (e, t) {
            window.alert(t);
          ...
          function () {
            if (o.pastLength < 1)
              return c.create(
                "infinite",
                "I mustn't (reload:) the page in the starting passage."
              );
            o.hasSessionStorage &&
        ...
        n.add(
          ...
          function (e, t, n) {
            ...
            var r = o.serialise();
            if (c.containsError(r)) return r;
            if (!1 === r) return !1;
            try {
              return (
                localStorage.setItem(p("Saved Game") + t, r),
                localStorage.setItem(p("Saved Game Filename") + t, n),
                !0
              );
            } catch (e) {
              return !1;
          ...
          "prompt",
          function (e, t, n) {
            return "function" != typeof window.prompt
              ? c.create(
                  "unimplemented",
                  "The (prompt:) macro doesn't seem to work in this browser. Sorry."
                )
              : window.prompt(t, n) || "";
          },
          [String, String]
          ...
          "confirm",
          function (e, t) {
            return "function" != typeof window.confirm
              ? c.create(
                  "unimplemented",
                  "The (confirm:) macro doesn't seem to work in this browser. Sorry."
                )
              : window.confirm(t);
          },
          [String]
      ...
      n.add(
        ...
        function (e) {
          ...
          return {
            ...
            TwineScript_Unstorable: !0,
            TwineScript_Print: function () {
              return t && l.create(t).render().html();
            },
          };
        },
        [w(c)]
        ...
        function (e) {
          for (
            ...
            if ("into" !== r.operator)
              return u.create(
                "macrocall",
                "Please say 'into' when using the (put:) macro."
              );
        ...
        function (e) {
          for (
            ...
            if (r.src && r.src.varref) {
              ...
              if (((i = r.dest.set(s)), (a = u.containsError(i))))
                return a;
              r.src.delete();
            } else if (
              ((i = r.dest.set(r.src)), (a = u.containsError(i)))
            )
              return a;
            o.options.debug &&
              (t += (t ? "; " : "") + f(r.dest) + " is now " + f(r.src));
        ...
        [x(Number, String), w(x(Number, String))]
      )(
        "rotated",
        function (e, t) {
          for (
          ...
          return (
            ...
            0 === t
              ...
              : r.slice(t).concat(r.slice(0, t)).map(m)
          );
        },
        [parseInt, S, w(S)]
      )(
        ...
        function (e, t) {
          ...
          if (t <= 0)
            return u.create(
              "macrocall",
              "I can't repeat these values " + t + " times."
            );
        ...
        n.add(
          ...
          function (e, t) {
            ...
            return r.map(function (n) {
              return t.apply(e, { loop: n });
            });
          },
          [s.TypeSignature("via"), T(S)]
        )(
          "find",
          function (e, t) {
            for (
          ...
          function (e, t) {
            for (
              ...
              r[i - 2] = arguments[i];
            return (
              "where" in t && (r = t.filter(e, r)),
              u.containsError(r) ||
                r.reduce(function (n, r) {
                  return t.apply(e, { making: n, loop: r });
                })
            );
          },
          [
            x(
              s.TypeSignature("where via making"),
              s.TypeSignature("via making")
            ),
            w(S),
          ]
        ),
        n.add(
          ...
          function () {
            ...
            do {
              ...
              n &&
                ...
                r.set(
                  n,
                  localStorage.getItem(e("Saved Game Filename") + n)
                ));
            } while (n);
            return r;
          },
          ...
          function (e) {
            for (
              ...
              n[r - 1] = arguments[r];
            return new Set(n.filter(g).map(m));
          },
          T(S)
        )(
          "count",
          function e(t, n) {
            ...
            switch (d(n)) {
              ...
              default:
                return u.create(
                  "macrocall",
                  f(n) + " can't contain values, let alone " + f(c) + "."
                );
            }
          },
          [S, w(S)]
    ...
    define("macrolib/stylechangers", [
      ...
      n.onStartup(function () {
        return e(n.storyElement)
          .on("mouseenter.hover-macro", "[hover=false]", function () {
            var t = e(this),
              n = t.data("hoverChanger");
            t.data({ mouseoutStyle: t.attr("style") || "" }),
              s.create({ target: t }, n).update(),
              t.attr("hover", !0);
          })
      ...
      t
        .addChanger(
          ...
          "live",
          function (e, t) {
            return o.create("live", [t]);
          },
          function (e, t) {
            (e.enabled = !1), (e.data.live = { delay: t });
          },
          p(Number)
        )(
          "event",
          ...
          function (e, t) {
            (e.enabled = !1), (e.data.live = { event: t });
          },
          a.TypeSignature("when")
        )(
          "hook",
          function (e, t) {
          ...
          function (e, t, n) {
            var r = t.filter(e.section, n),
              i = void 0;
            if ((i = c.containsError(r))) return i;
            e.loopVars[t.loop] = r || [];
          },
          [a.TypeSignature("where"), h(d)]
        )(
          ["transition", "t8n"],
          function (e, t) {
            return (
              (t = n.insensitiveName(t)),
              -1 === g.indexOf(t)
                ? c.create(
                    "macrocall",
                    "'" + t + "' is not a valid (transition:)",
                    m
                  )
                : o.create("transition", [t])
            );
          },
          function (e, t) {
          ...
          function (e, t) {
            return t <= 0
              ? c.create(
                  "macrocall",
                  "(transition-time:) should be a positive number of (milli)seconds, not " +
                    t
                )
              : o.create("transition-time", [t]);
          },
          function (e, t) {
          ...
          function (e, t) {
            return (
              i.isPrototypeOf(t) && (t = t.toRGBAString(t)),
              o.create("text-colour", [t])
            );
          },
          function (e, t) {
            return e.styles.push({ color: t }), e;
          },
          [l(String, i)]
        )(
          "text-rotate",
          ...
          function (t, r) {
            ...
            return (
              (o =
                i.isHexString(r) || i.isCSS3Function(r)
                  ? { "background-color": r }
                  : {
              ...
              t.styles.push(o, {
                display: function () {
                  return n.childrenProbablyInline(e(this))
                    ? "initial"
                    : "block";
                },
              }),
              ...
              var t = { color: "transparent" },
                r = Object.assign(Object.create(null), {
                  ...
                  shadow: {
                    "text-shadow": function () {
                      return (
                        "0.08em 0.08em 0.08em " + e(this).css("color")
                      );
                    },
                  },
                  emboss: {
              ...
              return [
                ...
                function (e, t) {
                  return (
                    (t = n.insensitiveName(t)),
                    t in r
                      ? o.create("text-style", [t])
                      : c.create(
                          "macrocall",
                          "'" + t + "' is not a valid (text-style:)",
                          "Only the following names are recognised (capitalisation and hyphens ignored): " +
                            Object.keys(r).join(", ")
                        )
                  );
                ...
                function (e, t) {
                  return (
                    n.assertMustHave(r, [t]),
                    (e.styles =
                      "none" === t ? [] : e.styles.concat(r[t])),
                    e
                  );
                },
              ];
        ...
        function (e, t) {
          return (e.data.hoverChanger = t), e.attr.push({ hover: !1 }), e;
        },
        [o]
      )(
        "css",
    ...
    define("internaltypes/enchantment", [
      "jquery",
      "utils",
      "internaltypes/changedescriptor",
    ], function (e, t, n) {
      var r = {
        create: function (n) {
          return (
            ...
            Object.assign(Object.create(this), { enchantments: e() }, n)
          );
        },
        enchantScope: function () {
          var r = this,
            ...
            u = this.scope;
          u instanceof e &&
            (u = Array.prototype.map.call(u, function (t) {
              return e(t);
            })),
            (this.enchantments = e()),
            u.forEach(s, function (e) {
              ...
              if (
                ...
                var l = n.create({ section: s, target: u });
                if ((c.run(l), l.update(), e.is(t.storyElement))) {
                  var f = Object.keys(
                    Object.assign.apply(
                      Object,
                      [{}].concat(_toConsumableArray(l.styles))
                    )
                  );
                  e.css(
                    ...
                    u.data({ enchantedProperties: f });
                }
              }
              e.is(t.storyElement) &&
                u.css({ width: "100%", height: "100%" }),
    ...
    define("macrolib/enchantments", [
          ...
          [
            function (e, t) {
              return t
                ...
                : l.create(
                    "datatype",
                    "A string given to this (" + r + ":) macro was empty."
                  );
            },
            function (e, t) {
              (e.enabled = !1),
                ...
                n.rerender &&
                  (e.newTargets = (e.newTargets || []).concat({
                    target: t,
                    append: n.rerender,
                  }));
              var r = _slicedToArray(e.section.stack, 1),
                ...
                a = u.create({
                  ...
                  attr: (n.classList + "").match(
                    /\b(?:link|enchantment-clickblock)\b/
                  )
                    ? { tabIndex: "0" }
                    : {},
                  data: {
                    enchantmentEvent: function () {
                      if (n.once) {
                        ...
                        e.section.enchantments.splice(t, 1),
                          a.disenchant();
                      }
                      if (n.goto)
                        return void i.goToPassage(n.goto, {
                          transitionOut: n.transitionOut,
                          transitionIn: n.transitionIn,
                        });
                      e.section.renderInto(
                        e.source,
                        null,
                        Object.assign({}, e, {
                          enabled: !0,
      ...
      a.addCommand(
        ...
        function (e, t) {
          var n = t.summary();
          if (n.includes("newTargets") || n.includes("target"))
            return l.create(
              "macrocall",
        ...
        function (e, t, n) {
          var r = u.create({ scope: s.from(t), changer: n, section: e });
          return e.enchantments.push(r), r.enchantScope(), "";
        },
        [h(s, String), c],
        !1
      );
      var g = ["replace", "append", "prepend"];
      g.forEach(function (t) {
        a.addChanger(
          ...
          function (e) {
            ...
            return r.every(Boolean)
              ? c.create(t, r.map(s.from))
              : l.create(
                  "datatype",
                  "A string given to this (" + t + ":) macro was empty."
                );
          },
          function (n) {
            for (
              ...
              o[a - 1] = arguments[a];
            return (
              e(n.target).parents().filter("tw-collapsed").length > 0 ||
                (n.attr = [].concat(_toConsumableArray(n.attr), [
                  { collapsing: !1 },
                ])),
              (n.newTargets = n.newTargets || []),
              (r = n.newTargets).push.apply(
                r,
                _toConsumableArray(
                  o
                    .filter(function (e) {
                    ...
                    .map(function (e) {
                      return { target: e, append: t, before: !0 };
                    })
                )
              ),
              n
        ...
        t.onStartup(function () {
          t.storyElement.on("click.enchantment", function () {
            Array.from(e(this).parents(".enchantment-clickblock"))
              .sort(function (e, t) {
      ...
      m.forEach(function (e) {
        return a.addChanger.apply(
          a,
          [e.name].concat(_toConsumableArray(f(e.enchantDesc, e.name)))
        );
      }),
        g.forEach(function (e) {
          m.forEach(function (t) {
            var n = Object.assign({}, t.enchantDesc, { rerender: e }),
              r = t.name + "-" + e;
            a.addChanger.apply(
              a,
              [r].concat(_toConsumableArray(f(n, r)))
            );
          });
        }),
        m.forEach(function (e) {
          ...
          a.addCommand(
            ...
            function (n, r, i, o) {
              ...
              return (
                (0, _slicedToArray(a, 2)[1])({ section: r }, s.from(i)),
                Object.assign(n, { source: "" })
              );
            },
            [h(s, String), String]
          );
    ...
    define("macrolib/links", [
      ...
      var l = t.TypeSignature,
        ...
        h = Object.assign;
      n.onStartup(function () {
        return e(n.storyElement).on(
          "click.passage-link",
          r.internalLink,
          function () {
            var t = e(this),
              n = t.closest("tw-expression"),
              r = t.closest("tw-expression, tw-hook").data("clickEvent");
            if (r) {
              if (t.find("tw-error").length > 0) return;
              return void r(t);
            }
            var i = n.data("linkPassageName"),
              o = n.data("t8nDepart"),
              s = n.data("t8nArrive"),
              c = n.data("t8nTime");
            return (
              n.find("tw-enchantment").each(function (t, n) {
                (o = e(n).data("t8nDepart") || o),
                  (s = e(n).data("t8nArrive") || s),
                  (c =
                    void 0 !== e(n).data("t8nTime")
                      ? e(n).data("t8nTime")
                      : c);
              }),
              i
                ? void a.goToPassage(i, {
                    transitionOut: o,
                    transitionIn: s,
                    transitionTime: c,
                  })
        ...
        [
          ...
          return t.addChanger(
            ...
            function (t, n) {
              return n
                ? s.create(e[0], [n])
                : u.create("macrocall", d[0]);
            },
            function (t, n) {
              t.innerSource || (t.innerSource = t.source),
                (t.source = "<tw-link tabindex=0>" + n + "</tw-link>"),
                (t.append = "link" === e[0] ? "replace" : "append"),
                (t.transitionDeferred = !0);
              var r = _slicedToArray(t.section.stack, 1),
                i = r[0].tempVariables;
              t.data.clickEvent = function (n) {
                "link-reveal" === e[0] && n.contents().unwrap(),
                  (t.source = t.innerSource + ""),
                  (t.transitionDeferred = !1),
        ...
        t.addCommand(
          ["link-goto"],
          function (e, t) {
            if (!e) return u.create.apply(u, ["macrocall"].concat(d));
            t || (t = e);
          },
          function (t, r, a, s) {
            var c = r.evaluateTwineMarkup(n.unescape(s || a)),
              u = void 0;
            c instanceof e && (u = c),
              o.hasValid(c) ||
                (u =
            ...
            return (
              (u =
                ...
                "<tw-link tabindex=0 " +
                  ...
                  a +
                  "</tw-link>"),
              (t.data.linkPassageName = c),
              h(t, { source: u, transitionDeferred: !0 })
            );
          },
          [String, f(String)]
        )(
          "link-undo",
          function (e) {
            if (!e) return u.create("macrocall", d[0]);
          },
          function (e, t, n) {
            return i.pastLength < 1
              ? u.create(
                  "macrocall",
                  "I can't use (link-undo:) on the first turn."
                )
              : h(e, {
        ...
        t.addChanger(
          ["link-reveal-goto"],
          function (t, r, i) {
            if (!r) return u.create.apply(u, ["macrocall"].concat(d));
            i || (i = r);
            var o = t.evaluateTwineMarkup(n.unescape(i || r));
            return o instanceof e
              ? o.data("TwineError")
              : s.create("link-reveal-goto", [r || i, o]);
          },
          function (e, t, r) {
            if (!o.hasValid(r))
            ...
            var c = _slicedToArray(e.section.stack, 1),
              u = c[0].tempVariables;
            e.data.clickEvent = function (t) {
              (e.source = e.innerSource),
                t.contents().unwrap(),
                (e.transitionDeferred = !1),
                e.section.renderInto(e.innerSource + "", null, e, u),
                e.target.find("[earlyexit]").length ||
                  a.goToPassage(r, {
                    transitionOut: e.data.t8nDepart,
                    transitionIn: e.data.t8nArrive,
                  });
    ...
    require.config({
      paths: {
        ...
        requestAnimationFrame:
          "../node_modules/requestanimationframe/app/requestAnimationFrame",
    ...
    require([
      ...
      var _installHandlers = function () {
        $(document.documentElement).on("keydown", function (e) {
          ...
          Engine.options.debug && DebugMode(),
      ...
      !(function (e) {
        ...
        Utils.onStartup(function () {
          ...
          if (0 !== e.length) {
            ...
            (Renderer.options.ifid = Engine.options.ifid = e.attr(
              "ifid"
            )),
              n ||
                (n = [].reduce.call(
                  $(Selectors.passageData),
                  function (e, t) {
              ...
              (n = $(Selectors.passageData + "[pid=" + n + "]").attr(
                "name"
              )),
              _installHandlers(),
              $(Selectors.script).each(function (e) {
                try {
                  ...
                  alert(
                    "There is a problem with this story's script (#" +
                      (e + 1) +
                      "):\n\n" +
                      t.message
                  );
            ...
            if (r && !0 === State.deserialise(r))
              return void Engine.showPassage(State.passage, !1);
